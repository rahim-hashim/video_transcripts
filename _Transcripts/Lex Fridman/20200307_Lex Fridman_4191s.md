...
Length: 4191s
Video Keywords: ['lee smolin', 'physics', 'quantum mechanics', 'einstein', 'eric weinstein', 'artificial intelligence', 'agi', 'ai', 'ai podcast', 'artificial intelligence podcast', 'lex fridman', 'lex podcast', 'lex mit', 'lex ai', 'lex jre', 'mit ai']
Video Views: 236717
Video Rating: None
Video Description: Lee Smolin is a theoretical physicist, co-inventor of loop quantum gravity, and a contributor of many interesting ideas to cosmology, quantum field theory, the foundations of quantum mechanics, theoretical biology, and the philosophy of science. He is the author of several books including one that critiques the state of physics and string theory called The Trouble with Physics, and his latest book, Einstein's Unfinished Revolution: The Search for What Lies Beyond the Quantum.
...
**Lex Fridman:** [March 07, 2020](https://www.youtube.com/watch?v=WgLo4gmEraU)
...
*  on the nature of our universe among the top minds
...
*  of Leonard Susskind, Sean Carroll, Michio Kaku,
...
*  and explore the first principles
...
*  We don't know.
*  This is science.
*  And I presume we're talking about science.
...
*  is something that we can never really grasp.
...
*  what happens when there are fires,
*  when there are not fires,
*  what animals and plants are good to eat and all that stuff.
*  But we're also just curious.
*  We look up in the sky and we see the sun
*  and the moon and the stars and we see some of those move
...
*  And where there are two things which I think are just true
*  of being human, we make judgments fast because we have to.
*  We're to survive, is that a tiger or is that not a tiger?
*  And we go.
*  Act.
...
*  To be right, well, since I believe
*  that there is a real world, I believe that to be,
*  you can challenge me on this if you're not a realist.
...
*  in this day and age?
*  Sure.
*  Paul Feyerabend, he was a student of Pomper
*  who taught.
*  Carl Pomper, yeah.
*  Carl Pomper.
*  And Feyerabend argued, both by logic
...
*  I think that,
*  I think of science as a community.
*  Of people.
*  And as a community of people bound by certain ethical
*  precepts, percepts, whatever that is.
...
*  Check.
*  The training of a scientist mostly consists of methods
*  of checking, because again, we make lots of mistakes.
...
*  for something that your colleagues will not be able
*  to shout down, because they'll ask, did you check this,
...
*  that kind of defense and argument, then they give you a PhD.
*  And you're kind of licensed.
*  You're still gonna be questioned, and you still may propose
*  or publish mistakes, but the community is gonna have
*  to waste less time fixing your mistakes.
*  But if you can maybe linger on it a little longer,
...
*  And Aristotelian would say, wow, of course it falls
*  right to the base of the tower.
*  That shows that the earth isn't moving
*  while the ball is falling.
*  And Galileo says, no wait, there's a principle of inertia,
*  and it has an inertia in the direction
*  with the earth isn't moving, and the tower and the ball
*  and the earth all move together.
...
*  And so you've gotta get an interconnected bunch of cases
...
*  they seem to do a better job at coming up with ideas
...
*  We'll straighten out, we'll get our string straight.
*  But there is nevertheless in science very often
*  at least temporary dead ends.
*  But if you look through centuries,
...
*  Yes.
*  It's a little barf.
*  I think it's important to get the time places right.
...
*  I mean, electrical technology was being developed slowly
*  with this and in fact, there's a close relation
...
*  now your new book before string theory,
*  quantum mechanics, so on,
...
*  Okay, so realism is the idea that while the ground is solid,
*  you can describe it.
*  What's the role of the human being,
*  our beautiful, complex human mind
*  in realism?
*  Do we have a, are we just another set of molecules
*  connected together in a clever way, or the observer,
*  does the observer, our human mind, consciousness,
*  have a role in this realism view of the physical universe?
...
*  and consciousness in mind, and that's question two.
...
*  I'm not sure.
*  I'm a good scholar and can talk about the different camps
*  and analyze it.
...
*  And we're free to invent and use terms like particle
*  or wave or causality or time or space.
...
*  or the universality of mathematics or of computing
*  and so forth.
...
*  or in the wrong angle,
*  they're ways to fail.
*  But if you somehow have the right luck,
*  the right confidence and arrogance,
*  caring, I think Einstein cared to understand nature
*  with ferocity and commitment
...
*  of the duality of particle and wave for photons.
*  And he was, I mean, people I think
*  don't always associate Einstein with quantum mechanics
...
*  as it was developed in the late 19th,
*  middle late 1920s was completely correct.
...
*  and little things, and it's unfinished
*  because we have two totally separate things
*  and we need to figure out how to connect them
...
*  So I believe that space-time
*  is an intellectual construction that we make
...
*  This is this idea of causality.
*  Okay, so that's real.
*  So that's in my...
*  In your view, is real.
*  Or hypothesis, or the theories that I have been
*  working to develop make that assumption.
*  So space-time, you said four-dimensional,
...
*  But, and if Cosalia's fundamental,
...
*  And an event is a moment of time within space.
...
*  Now we are postulating the theories at the fundamental level
*  a notion which is an elementary notion.
*  So it doesn't have a definition in terms of other things
*  but it is something elementary happening.
*  And it doesn't have a connection to energy or matter
*  or exchange of energy?
*  It does have a connection to energy and matter.
*  So it's at that level.
*  Yeah, it involves, and that's why the version
*  of a theory of events that I've developed
*  with Marina Cortez.
*  And it's, by the way, I want to mention my collaborators
...
*  So, and focus on causality as a fundamental to physics.
*  And there's certainly other people we've worked with
*  but those two people's thinking had a huge influence
*  on my own thinking.
...
*  and you asked me to define emergent, I didn't.
*  An emergent property is a property that arises
*  at some level of complexity, larger than and more complex
*  than the fundamental level,
*  which requires some property to describe it,
*  which is not directly explicable or derivable,
*  is the word I want,
...
*  we saw how this happens in detail in some of our works.
...
*  So it's not about gravity in general
...
*  and we need it for our survival, but it's not fundamental?
*  I mean, it seems crazy for it
*  to be a fundamental aspect of our reality.
*  It does.
*  Can you comfort me sort of as a therapist?
*  Like, how do I?
...
*  In quantum field theory, which is a mixture
...
*  and then share a property without it being a property
...
*  and particle B, which is over here on my left.
...
*  or the speed of light away from each other.
...
*  or 100 and something kilometers.
*  So in trying to solve the unsolved revolution,
*  in trying to come up with a theory for everything,
...
*  not no but, but yes and.
*  Yes, your idea goes this far,
*  but maybe if we put it together with my idea,
*  we can go further.
*  Yes.
*  So in that spirit, I've talked several times with Sean Carroll
*  who's also written an excellent book recently.
*  And he plays around as a big fan
*  of the many worlds interpretation of quantum mechanics.
*  So I'm a troublemaker, so let me ask,
*  what's your sense of Sean
...
*  And there's this mysterious thing that we so often end up
*  on the opposite sides of with these issues.
*  It's fun though.
...
*  Sean has a podcast, you should definitely figure out
*  how to talk to Sean.
...
*  but there's something that Sean said to me in June of 2016
*  that changed my whole approach to a problem.
*  But I have to tell him first.
*  Yes, and that'll be great to tell him on his podcast.
*  So.
*  I can't invite myself to his podcast.
*  Yeah, okay, we'll make it happen.
*  So many worlds.
*  Anyway.
*  What's your view?
...
*  it's very difficult to far limit human minds to comprehend.
...
*  that when Roberto, Mangiber, Angra and I
*  began looking for principles,
*  and I wanna come back and talk about
...
*  The many worlds interpretation cuts off one,
*  the one having to do with measurement
*  and just has the other one, the Schrodinger evolution,
*  which is the smooth evolution of the quantum state.
...
*  but I'll use it.
*  There is a branch in which everything that might happen
...
*  And my understanding, although I'm not as much of an expert
...
*  have tried to make versions
*  of what you might call many worlds quantum mechanics.
...
*  in the book I wrote,
*  chapter 10, which is about Everett's version, chapter 11.
*  There's a very good group of philosophers of physics
*  in Oxford, Simon Sanders, David Wallace, Harvey Brown,
...
*  there are really no probabilities, we admit that.
*  But imagine if the Everett story was true
...
*  if you were inside an Everettian universe and you knew that.
*  And there is a debate among those experts
...
*  and it didn't make sense to me, but I didn't study it hard,
...
*  approaches are all models which might describe indeed
*  some quantum gravity physics in some domain,
*  in some aspect, but ultimately would be important
*  because they model the principles and the first job
*  is to tie down those principles.
...
*  because you can't as an author to claim
*  after all the work you put in that you were misread.
*  But I will say that many of the reviewers
*  who were not personally involved and even many
...
*  And this is-
*  On which topic?
*  On string theory specifically or in general in physics?
*  No, more specifically than string theory.
*  So since we're in Cambridge, can I say that?
*  We're doing this in Cambridge?
*  Yeah, of course, Cambridge, just to be clear, Massachusetts.
*  And on Harvard campus.
*  Right, so Andy Strominger is a good friend of mine
...
*  to string theory found which led each of them
*  to a different version of particle physics
*  with a different phenomenology.
*  These are called the Calabi-Yau manifolds
*  named after Yau who was also here.
...
*  of mathematical curvature called torsion into the solutions.
...
*  for anything the experiments discover.
...
*  like Lin-Margulis and Steve Gould and so forth.
*  And I could take your time to go through the things,
*  but it occurred to me maybe physics
*  was like evolutionary biology.
*  And maybe the laws evolved and there was,
...
*  so it's the laws of physics are changing.
*  This idea would say that the laws of physics
*  are changing in some way that echoes
*  that of natural selection or just it adjusts
*  in some way towards some goal.
*  Yes, and I published that.
*  I wrote the paper in the 1880s or 89,
*  the paper was published in 92.
*  My first book in 1997, The Life of the Cosmos
*  was explicitly about that.
...
*  So that's a really compelling notion,
*  but how does that help you arrive?
*  I'm coming to where the book came from.
*  Yes.
*  So what got me, I worked on string theory,
...
*  of how science works based on a community and ethics
...
*  And you can find their remnants in what's now the last part
...
*  in science and know of, including,
...
*  not just your own work on now with causality
*  and nonlocality, but just broadly
*  in understanding the fundamental nature of our reality,
...
*  And now let me leave you with some words from Lee Smullen.
