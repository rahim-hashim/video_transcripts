...
Length: 5440s
Video Keywords: ['agi', 'ai', 'ai podcast', 'artificial intelligence', 'artificial intelligence podcast', 'education', 'jo boaler', 'learning', 'lex ai', 'lex fridman', 'lex jre', 'lex mit', 'lex podcast', 'math', 'mathematics', 'maths', 'mit ai', 'stanford', 'youcubed', 'математика']
Video Views: 172217
Video Rating: None
---

# Jo Boaler: How to Learn Math | Lex Fridman Podcast #226
**Lex Fridman:** [September 27, 2021](https://www.youtube.com/watch?v=KZnGSVwIpeU)
...
*  I love a mathematics that some people don't even think of as mathematics,
*  which is beautiful, creative mathematics,
*  where we look at maths in different ways, we visualize it,
*  we think about different solutions to problems.
*  A lot of people think of maths as you have one method and one answer,
*  and what I love about maths is the multiple different ways you can see things,
...
*  And also the sad part that many people think that maths is just one answer and one method.
*  So to you, the beautiful...
*  the beauty emerges when you have a problem with a solution
*  and you start adding other solutions, simpler solutions,
*  weirder solutions, more interesting, some that are visual,
*  some that are algebraic, geometry, all that kind of stuff.
*  Yeah. I mean, I always say that you can take any maths area and make it visual.
...
*  it's been a great disservice to kids and others that it's always been numbers,
...
*  I mean, there's definitely people who come into the classes I do
*  who are more interested in visual thinking and like visual approaches.
*  But it turns out what the neuroscience is telling us is that when we think about maths,
*  there are two visual pathways in the brain, and we should all be thinking about it visually.
*  Some approaches have been to say, well, you're a visual learner,
...
*  You were saying that there's some kind of interconnected aspect to it,
*  so the visual connects with the non-visual.
*  Yeah, so this is what the neuroscience has shown us,
*  that when you work on a maths problem, there are five different brain pathways,
*  and that the most high achieving people in the world
*  are people who have more connections between these pathways.
*  So if you see a maths problem with numbers, but you also see it visually,
*  that will cause a connection to happen in your brain between these pathways.
...
*  I find physicists are often better at building that part of their brain,
*  using visualisation for intuition building,
*  because you ultimately want to understand the deepest secret underneath this problem,
*  and for that you have to intuit your way there.
*  And you mentioned offline that one of the ways you might approach a problem
*  is to try to tell a story about it.
*  And some of it is like legend, but I'm sure it's not always.
*  You have Einstein thinking about a train, and the speed of light,
...
*  and think, is this going to be true, is this going to be true?
*  Einstein is well known for thinking visually,
*  and people talk about how he really didn't want to go anywhere with problems
*  without thinking about them visually.
*  But the other thing you mentioned that sparked something for me
*  is thinking with intuition, like having intuition about maths problems.
*  That's another thing that's often absent in maths class,
*  the idea that you might think about a problem and use your intuition,
*  but so important.
*  And when mathematicians are interviewed,
*  they will very frequently talk about the role of intuition in solving problems,
*  but not commonly acknowledged or brought into education.
*  That's what it is.
*  If you task yourself with building an intuition about a problem,
*  that's when you start to pull in,
*  what is the pattern I'm seeing?
*  In order to understand the pattern, you might want to then start utilizing visualization,
*  but ultimately, that's all in service of solving the puzzle,
*  like cracking it open to get the simple explanation of why things are the way they are,
...
*  who is a great mathematician, you might think of him, an AI person.
*  I remember in one interview I did with him,
*  he talked about how they'd built robots, I think, for the Smithsonian,
*  and how they were having this trouble with them picking up white noise.
*  And he said they had to solve it, they had to work out what was going on,
*  and how he intuitively worked out what the problem was.
*  But then it took him three weeks to show it mathematically.
*  I thought that was really interesting,
*  how you can have this intuition and know something works.
*  It's kind of different from going through that long mathematical process of proving it,
*  but so important.
*  Yeah, I think probably our brains are evolved
*  as intuition machines,
*  and the math of showing it formally is probably an extra thing that we're not designed for.
*  You see that with Feynman and his...
*  I mean, all of these physicists, definitely you see...
*  starting with intuition, sometimes starting with an experiment,
*  and then the experiment inspires intuition.
*  But you can think of an experiment as a kind of visualization.
*  Just like, let's take whatever the heck we're looking at and draw it,
*  and draw the pattern as it evolves, as the thing grows,
*  for n equals one, for n equals two, n equals three, and you start to play with it.
...
*  I tend to not like interactive because it takes way too much work,
...
*  So you can do all these kinds of visualizations,
*  and then there's the tools of visualization, like color, all those kinds of things.
*  You're absolutely right, they're actually not taught very much.
...
*  Ask a difficult question here.
*  So there's kind of...
*  I don't know what the right term is, but some people are...
*  struggle with learning in different ways.
*  Like their brain is constructed in different ways.
*  And how much should, as educators, should we make room for that?
...
*  in very different ways, I can't learn it this way?
*  How do you find that line? How do you operate in that gray area?
*  So this is why being a teacher is so hard.
*  And people really don't appreciate how difficult teaching is
*  when you're faced with, I don't know, 30 students
...
*  We've really offered it in one way, which is,
*  here's some numbers in a method, you follow me,
*  do what I just did, and then reproduce it.
...
*  in a particular way, that's why we want to...
...
*  That's good. Well, good that you fell in love.
*  You're about to force.
*  But something we talked about a little bit,
...
*  And it's not improving, it's being really good.
*  We are much more like that with sports, for example.
*  It's understood, you're going to star on the basketball team,
*  if you're going to start on the basketball team,
*  if you're going to be better than the other girls on the team.
...
*  But I thought...
*  My dad, early on, told me, just offhand,
...
*  And the tools of mathematics were in service of that dream
...
*  is just the sheer hours of math.
*  The number of courses, you're talking about
*  a lot of geometry, a lot more geometry.
...
*  But that would be huge, that change.
...
*  And that's when kids start to feel
*  really badly about themselves.
*  So middle school years,
...
*  but do you think teachers should almost do one-on-one,
*  little Johnny, I believe in you kind of thing?
...
*  I say, I'm not suggesting you put on the bottom
*  of all kids' work, I'm giving this feedback
*  because I believe in you.
...
*  I sometimes, it's such a funny dance
*  because I'm almost such a perfectionist,
...
*  But the reality is, if you look at many great people
*  throughout history, they sucked at some point.
*  Yeah, exactly.
...
*  is filled with people who are dropouts of school
...
*  often slower thinkers.
*  They think slowly and deeply.
...
*  but he talks a lot about having
*  a non-standard way of learning.
...
*  Absolutely.
*  I mean, I think education system
*  still uses an approach that was in classrooms
...
*  called Maryam Mizikhani.
*  I don't think you've heard of her.
...
*  And I attended, she asked me to chair the PhD defense
...
*  But when Maryam Izakhani won the Fields Medal,
*  all these other mathematicians were saying
*  that her work had connected all these previously
*  unconnected areas of maths.
*  But when she was, she also shared that when she was in school,
*  when she was about 13, she was told
*  that she couldn't do maths.
*  She was told that by her teacher.
*  This is Iran?
*  Oh, she grew up in Iran.
*  So I love that.
...
*  like the one teacher that changed everything for them.
...
*  given the incentives, you have the power
*  to truly change lives.
*  And like 20 years from now,
*  I feel as medalists will walk up to you and say thank you.
*  You did that for me.
*  Yeah, absolutely.
*  And I share that with teachers that even in this
*  broken system of what they have to do
*  for districts and textbooks,
...
*  So...
*  Oh, that's so funny.
*  Yeah, there are some interesting implications for this.
...
*  with maths, you hate maths, you have maths anxiety,
...
*  Are parents okay with sucking at math
*  and then trying to get their kid
*  to be better than them essentially?
*  Is that difficult thing for a lot of parents?
*  It is difficult.
*  It's almost an ego thing.
*  I never got good at this
*  and probably should have.
*  Yeah, I mean, to me, you wanna celebrate that,
...
*  Yeah.
*  So do you experience the same with parents?
*  Parents too.
...
*  which is why I say you should fake it.
...
*  And so do many parents believe that.
...
*  on top of this whole old school,
...
*  that have been written and then textbooks
*  have taken these standards and made not very good questions.
...
*  So teachers don't see the connections between ideas
*  nor do the kids.
...
*  within mathematics, square tiles, measuring,
*  fraction, shape and time,
...
*  that teachers measuring to kids?
...
*  what are the big ideas and what are really rich,
*  deep activities that teach those big ideas.
*  So that's the, like how you teach it and maximize learning.
...
*  So that's your summative achievement.
*  But the problem we have in maths classrooms across the US
*  is people use grades all the time,
...
*  I do think this might be more for college, but maybe not.
...
*  And then I have a few in mind, one in particular,
...
*  So this happened to be an artificial intelligence class.
*  But I think that special treatment of taking students
*  who are especially excellent at a particular little aspect,
*  do you see their eyes light up?
*  I often think maybe it's tempting for a teacher
*  to think you've already succeeded there,
*  but they're actually signaling to you
*  that you could really launch them on their way.
...
*  And it's those people who really didn't just inspire me
*  with their awesomeness, which they did,
*  but also just they pushed me a little.
*  And that requires focusing on the quote unquote excellent
*  students in the class.
*  Yeah, I think what's important though,
*  is teachers to have the perspective
*  that they don't know who's gonna be excellent
*  at something before they give out the activity.
*  Exactly.
...
*  And over time we encouraged them to extend things further.
...
*  And one of the boys came up at the end of the class and said,
*  I've been thinking about how you do this with a pentagon.
...
*  It's great.
*  And then you also, this is like teacher and coach,
*  you could say it in different ways to different students.
*  For me, the right thing to say is almost to say,
*  I don't think you could do this, this is too hard.
*  That's what I need to hear.
*  It's like, no, there's immediate push.
...
*  So you have to be also sensitive to that.
...
*  that some kids have developed that ability, if you like,
...
*  of how well they're gonna do maths.
*  Anyway, I diverge.
...
*  of that creative flexible thinking.
...
*  the first one was kind of a disaster because they were all
*  like, they're better than me, they're faster than me.
...
*  So there's little like red pen section
...
*  And what was so eyeopening for these undergrads
*  and they talked about it in lovely ways was,
*  I learned to value other people's thinking on a problem.
...
*  And like the first, cause he had a few,
...
*  And then together, he pulled me in,
*  in that particular case,
*  he doesn't know in particular like that much
...
*  and at the career level, at every single stage,
*  I think that's ultimately.
*  I agree with you, I think that's a really good way
*  of thinking about it.
*  You mentioned textbooks.
*  And you didn't say it,
*  maybe textbooks isn't the perfect way to teach mathematics.
*  But I love textbooks, they're like pretty pictures
...
*  It's like Wikipedia, but with color and nice little.
*  You must have seen some good textbooks
*  if they had pretty pictures and color.
*  Yeah, I mean, I remember, I guess it was very, very standard
*  like AP calculus, AP biology, AP chemistry.
*  I felt those are like some of the happiest days
*  of my life in terms of learning was high school.
*  Because it was very easy, honestly.
*  It felt hard at the time,
*  but you're basically doing a world-win tour
*  of all the science.
*  Yeah, yeah.
*  Without having to pick, you do like literature,
*  you do like Shakespeare, you do calculus, biology, physics,
*  chemistry, what else, anatomy, physiology,
*  computer science, without like, nobody's telling you
...
*  Well, I'm intrigued that you had
*  such a good experience with textbooks.
*  I mean, I can remember loving some textbooks
*  I had when I was learning, and I loved books.
*  I loved to pick up books and look through them.
...
*  Textbook's kind of like the Bible.
...
*  because they weren't just trotting through exercises,
*  exercises.
*  Like what a textbook allows you is like,
*  you're, the very thing you said they might not like,
*  the 2.3, 2., it feels like you're making progress.
*  And it's a little celebration
...
*  Then you make that little step and further progress.
...
*  I mean, I grew up in England, and in England,
*  we learn maths.
...
*  doesn't have to be a calculation.
*  And so yeah, I like maths
*  because it has more of that broad feel to it.
*  Yeah, I love that.
*  Maths kind of emphasizes the multi-dimensional,
*  like a variety of different sub-disciplines,
*  different approaches.
*  Okay, but outside of the textbook,
*  what do you see broadly being used?
*  You mentioned Sebastian Thrun and MOOCs, online education.
...
*  And I remember releasing it that first summer
...
*  and sharing it.
*  And it was like, took off.
*  In fact, it was that MOOC that got me to create U cubed
*  with Cathy Williams, who's the co-founder,
...
*  Now that's really effective.
*  You mentioned Ucubed.
*  So what's the mission, what's the goal?
*  You mentioned how it started, but what's,
*  yeah, where are you at now and what do you,
*  what's your dream with it?
*  What are the kind of things that people
*  should go and check out on there?
*  Yeah, we started Ucubed, I guess it was about five years ago
*  now and we've had over 52 million visitors to the site.
*  So I'm very happy about that.
*  And our goal is to share good ideas for teaching
*  with teachers, students, parents in maths and to help.
*  We have a sort of sub goal of erasing maths anxiety.
*  That's important to us, but also to share maths
*  as this beautiful creative subject.
*  And it's been really great.
*  We have lessons on the site, but one of the things,
*  one of the reasons I thought this was needed
*  is there's a lot of knowledge in the academy
*  about how to teach maths well, loads and loads of research
*  and journals and lots of things written up,
...
*  So this I see as a big problem.
*  You have this whole industry of people finding out
*  how to teach well, not sharing it
*  with the people who are teaching.
...
*  The kids lights were on, they were excited.
*  They loved it.
...
*  It is.
*  I wish, I mean, what I would love is if we could actually
*  extend that for the whole year.
*  We were a small team at Stanford and we're trying to keep up
*  with great things to put on the site.
*  We haven't the capacity to produce these creative
*  visual maths tasks for every year group for every day.
...
*  and we made K-8 maths books with exactly that.
...
*  So now there's a whole K-8 set of books
...
*  knows about U cubed.
*  At the moment, a lot of teachers who come to us
...
*  and know what you do when you don't understand.
...
*  it's the polygon thing you mentioned from a square,
...
*  a question I get asked a lot is about homework.
*  It's a good thing for kids to do for homework.
...
*  Kids are going through maths questions,
...
*  I think most of us go through life never asking
*  like the bigger question.
*  Almost like, you know, those like layers of why questions
*  that kids ask when they're very young.
*  Yeah.
*  We need to keep doing that.
*  We do.
*  Like what, that's the, you know, whatever the term is,
*  you call first principles thinking,
*  and people call it that, which is like,
...
*  who your like romantic partner is, like everything.
*  Everything, yeah.
...
*  I think about is the questions kids ask in school
*  goes down like in a linear progression from,
*  in the early years, you can't stop kids
...
*  And the teacher said, and it was like the first class
*  of this teacher's class,
...
*  the lesson you learned from that is I'm not gonna ask.
...
*  we put them up on walls and celebrate.
...
*  He had an amazing professor named Alicia Caffonde
*  in computer science.
*  And he would encourage questions,
*  but then he would tell everybody
*  how dumb their questions are.
*  But it was, I guess, if you say it with love
*  and respect behind it, then it's more like
*  a friendly, humorous encouragement for more questions.
*  It's an art, right?
*  Yeah, that's right.
*  Teaching is very hard.
*  You have to time it right, because that kind of humor
*  is probably better for when you're in grad school versus.
*  Yeah, it's a lot of fun.
*  In grad school versus when you're in early education.
*  Right.
*  Well, and I guess kids or young people get
*  whether somebody's doing it to be funny or, you know,
*  has it, I mean, this is why teaching is so hard.
*  Even your tone can be impactful.
*  It's so sad, because for that particular human,
*  the teacher, you could just had a bad day,
*  and one statement can have a profound negative impact.
*  I know, sadly, that math, there's a lot of math teachers
*  who have that kind of approach, and they,
*  I think they're suffering from the fact that
*  they think people are math people, not math people,
...
*  And I myself had like one teacher who was really amazing
*  for me in maths, and she kept me in the subject.
*  I would have been left in.
*  Who was she?
...
*  because you're more specialized, but anyways.
*  She was my teacher, and for the first time
*  in my whole career in maths, she would give us problems
...
*  and come up with solutions, and I was like,
...
*  and he's a mathematician, theoretical computer scientist,
...
*  that require thinking like math does, difficult.
...
*  They actually realise, I give a problem out
...
*  never once working on a problem in that kind of deep way.
...
*  okay, I never wanna go back to that maths relationship I had
...
*  if you're really thinking about a problem.
*  And I think it's really important to realize
*  that that's a skill that you can,
*  just like a muscle you can build,
*  you can start with five minutes and go to 10 minutes
*  to 30 and to an hour.
...
*  Grant Sanderson, 3 Luan Brown.
*  So he's inspired millions of people
*  with exactly the kind of way of thinking
*  that you've been talking about.
*  Yeah, I love his work.
*  Converting mathematical concepts into visual,
*  visually representing them, exploring them in ways
*  that help you illuminate the concepts.
...
*  So part of his storytelling, part of his like,
*  it's creating the visuals and then weaving a story
*  with those visuals that kind of builds.
*  Like there's also, I mean, there's also drama in it.
*  You start with a small example and then you kind of,
...
*  Like the core curriculum, which is something,
*  he sees himself as an inspirational figure.
*  Because I think it's too difficult to kind of convert
*  all of the curriculum into those elements.
...
*  And maybe they could go on to take some other
*  mathematical idea and make it that beautiful.
*  Well, he does that.
*  He created a library called Manum and he open sourced it.
*  And that library is the, people should check it out.
*  It's written in Python and uses some of those same elements.
*  Like it allows you to animate equations
*  and animate little shapes.
*  Like people that, he has a very distinct style in his videos
*  and what that resulted in, even though
...
*  And the cool, to me personally, the coolest thing
*  is to see like people that are not,
*  don't have like a million subscribers or something,
*  they have just a few views in the video,
*  but it just seems like the process of them creating a video
*  where they teach is like transformative to them
...
*  Yeah, absolutely.
*  I think just giving people that idea that you can do that
*  with maths and other subjects,
*  there's bound to be people all around who can create more,
*  which is cool.
*  Yeah, I definitely, so I recommend people do like
...
*  I mean, it's something in us that loves patterns,
*  loves figuring out difficult things
...
*  You can have a number and double the number.
*  So yeah, I just think there are patterns everywhere.
*  And if kids are thinking their role is to see patterns
*  and find patterns, it's really exciting.
*  What do you think about MIT OpenCourseWare
...
*  in that there's still more to be done to help
*  that online learning reach those principles.
*  But definitely I think it's a good invention.
*  And I have an online class that's for kids
*  that's a little free class that gives some-
*  What's the topic?
...
*  in their maths class and do better at the end of the year.
...
*  how to live a life that they can be proud of.
...
*  I know that millions of kids are in the school system
*  have been given the message they cannot do things.
*  And adults too, they have the idea, oh, I did okay in this.
*  I went into this job because those other things
*  I could never have done okay in.
*  So actually when they hear,
*  hey, maybe you could do those other things,
*  even adults think, you know, maybe I can.
*  They go back and they encounter this knowledge
...
*  What I find in my life with people that love me,
*  when you achieve success, they keep celebrating
*  your success and they want you to keep doing the thing
*  that you were successful at as opposed to believing
*  in that you can do something else,
...
*  to seek out the people, like surround yourself
*  with people that will believe in you.
*  It's like a little bit is on you.
*  It's like you don't get that sometimes
*  if you go to grad school, you think you kind of land
*  on a mentor, maybe you pick a mentor based on the topic
*  they're interested in, but the reality is the people
...
*  They love you deeply, but they set,
*  it's the math thing we mentioned,
...
*  So sad the number of people who've had those negative
...
*  Change can happen in the education system.
...
*  a course you can take in high school instead of Algebra 2.
*  And that's pretty amazing because that content was set out
*  in 1892 and hasn't changed since then.
...
*  and think they were hilarious, but maybe we'll,
*  in the future, kids will be doing their own programming
*  and they'll be able to learn things and find out things
*  and create things even as they're learning.
*  And maybe the individual subjects boundaries will go.
...
*  Where does it go?
*  And who teaches it?
*  So it's already raising those kinds of questions
...
*  I wonder how that got initiated.
*  Like, how does change happen in the education system?
*  Is it just a few revolutionary leaders?
*  I think so.
*  I think so.
*  It's been an interesting journey seeing data science take off,
*  actually.
*  There was a course that was developed in 2014
*  by some people who thought data science was
*  a good idea for high schoolers.
...
*  So that was like a big green light
*  for a lot of schools who were wondering about whether they
*  could teach it.
*  So I think it happens in small spaces and expands.
*  So now it goes viral.
*  Yeah.
*  In this modern age.
*  Then it goes viral.
*  California is ahead, I think, in creating courses
*  and having kids go through it.
*  But suddenly when I last looked, there
*  were 12 states that were allowing data science
...
*  by educating them, by inspiring teachers
*  to educate in the ways that you've
*  talked about in multidimensional ways, in visual ways,
*  I think is incredible.
*  So you're spreading beauty into the world.
*  So I really, really appreciate that you
*  spent your valuable time with me today.
