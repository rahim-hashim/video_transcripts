...
*  There is no surprise as to how that all works, however.
...
*  it's just a name, you don't need to know the name,
...
*  involving melatonin as sort of a brake
...
*  and to prevent or reverse aging is going to be
*  to increase ATP and to reduce reactive oxygen species.
...
*  and reactive oxygen species in ATP work.
...
*  even though it's in this very specific form of visual testing,
*  this Triton exam or this Triton score.
...
*  Cones for whatever reason are pretty resilient
*  to age-related loss.
...
*  But that of course is what I call anechidata.
...
*  almost exclusively talking about anechidata
*  only when highlighting it as anechidata.
*  So if you're somebody who wants to explore
*  red light therapy, here's what you need to do.
...
*  Chances are it is, and yet I would still encourage you
*  to talk to your optometrist or ophthalmologist
*  before getting into any extensive protocols.
*  But if you are still determined to pursue
...
*  The authors of this study emphasize
...
*  as if you need to turn away during the period
...
*  So that can be a useful guide in terms of gauging
*  how bright a light should be,
*  or at least how far away you should be from a bright source
*  in order to safely engage with that light source.
*  So the studies I just described,
*  once again, involve the use of red light early in the day
*  within three hours of waking
*  and are for the sake of improving neuronal function.
*  Red light has also been shown to be beneficial late
*  in the day and even in the middle of the night.
...
*  available just as red light bulbs, you don't need a panel.
...
*  So beautiful study, they explored the use
...
*  How much does light of a given color and intensity
*  suppress melatonin?
...
*  of shining different wavelengths of light on the skin
*  or on our eyes and the downstream health consequences
*  of that illumination.
*  However, one of the most important goals of science
*  and medicine is to figure out how to change the health
*  of our brain.
*  And of course, our brain is contained within our skull
*  and therefore we can't just shine light
*  onto the outside of our head
*  and expect it to change the activity of neurons
...
*  and hormone circuits to our eye
...
*  will also often have the effect of reducing certain neurons,
...
*  is that there's a particular pattern
*  of brain activity called gamma activity.
...
*  So you can think of, you know, delta waves,
...
*  you're going to think about that as longer wavelength firing.
*  Turns out that gamma waves are one pattern of firing
*  that leads to downstream metabolic functions
*  and biological functions
*  that end up clearing away debris
...
*  Well, what Li Wei, Sai and colleagues have beautifully shown
...
*  of light flicker, even though many of the brain areas
*  that do this are not directly within the visual system
*  or visual pathway.
...
*  the stimulation was called GENUS,
...
*  and the cause of age-related cognitive decline and Alzheimer's.
...
*  and so on and so on.
*  They have discovered and list out
*  a huge number of these biological effects,
...
*  The Psi Lab and other labs are really starting to explore
...
*  and other forms of neuromal degeneration.
...
*  of a given continuous frequency can induce seizure.
...
*  of visual flicker, in most cases strobe,
...
*  In fact, I get a lot of questions
*  such as can red light be used to improve testosterone output?
...
*  or suggestions about topics that you'd like us to cover
*  in a future podcast episode
*  or guests that you would like me to interview
*  for the Huberman Lab podcast,
*  please put all those suggestions, comments and questions
...
*  because Thorne supplements are the very highest quality
*  and stringency.
...
*  And if you happen to navigate deeper into the Thorne site
...
*  And we have a very clear privacy policy there
*  at that website if you choose to explore it.
*  I'm also pleased to announce
*  that we have some live events coming up.
*  So I will be giving a lecture called
...
*  To access tickets,
*  you can go to the link at hubermanlab.com slash tour.
