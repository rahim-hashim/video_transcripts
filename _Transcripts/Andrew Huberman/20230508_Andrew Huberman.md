...
*  In other words, the SSRIs of which there's now
...
*  for particular brain rewiring outcomes that yes,
...
*  but then transitions into music that has a lot
...
*  to the point where sometimes they just stop trying
...
*  out of the room, jump out of a window, run into traffic.
...
*  entitled, Psychedelics and Neuroplasticity,
*  a systematic review unraveling the biological underpinnings
*  of psychedelics.
...
*  are interested in, but if you are interested
*  in that level of detail,
*  this is a wonderful open access review.
*  So a few minutes ago, I talked about where there is strong,
*  modest and somewhat weak, or rather I should say,
*  minimal evidence for the therapeutic use of psilocybin
*  to treat various disorders.
*  And across the board, it really appears
*  that major depression and so-called intractable depression
*  in some cases is where we're seeing
*  the most exciting research to date.
*  Now keep in mind that because of the Controlled Substance Act
...
*  including psilocybin, received what's called
*  breakthrough status at the FDA,
*  that there are now a lot of clinical trials exploring
*  how psilocybin can impact various things
...
*  such as Robin Cardart Harris, but also Matthew Johnson,
*  Roland Griffiths, Nolan Williams and many others.
...
*  because I've had the great fortune of having Matthew Johnson
...
*  with Dr. Robin Cardart Harris to talk about his work
...
*  about what has been observed in terms
*  of using psilocybin journeys as a way to treat depression
*  because the data are just oh, so exciting.
*  Again, these data really started to surface
*  as the consequence of studies that were initiated
*  around 2006 in just a few select laboratories
...
*  I'm about to describe were published in,
...
*  Essentially, all of these clinical studies involve
*  either one or two psilocybin sessions.
*  The dosages that were explored range from zero milligrams,
*  a placebo, if you will, 10 milligrams,
*  some cases 25 milligrams, in some cases 30 milligrams.
*  And most typically people receive the same dosage
*  for both sessions if indeed they did both sessions.
*  However, there's at least one study looking
*  at just one single episode of psilocybin administration.
...
*  They randomly assigned subjects who had treatment
...
*  10 milligrams, or one milligram,
...
*  again, at the three different doses, 25, 10, or one milligram.
...
*  but among the most important results I can summarize
*  from the discussion and here I'm paraphrasing
*  that the change in baseline levels of depression that is,
...
*  This really points to the fact that the 25
*  to 30 milligram dose that's used
*  in the largest numbers of studies
...
*  so that one doesn't just translate the 25 milligrams
*  is better than 10 milligrams,
*  although in this study it was for sake
*  of treatment resistant depression relief.
...
*  from treatment of resistant depression
...
*  of depression relief 12 weeks after
*  the single 25 milligram psilocybin dose session.
...
*  of neurochemistry, where that's possible,
*  in terms of trying to understand if and how psilocybin
*  is effective for the treatment of depression.
...
*  The Effects of Psilocybin-Assisted Therapy
...
*  all subjects were encouraged not to avoid taking
*  those antidepressant medications
...
*  In other words, four times the positive effect observed
*  with typical SSRIs or other pharmacology of that sort.
...
*  really point to the incredible role that psilocybin can have
*  in creating an experience inside of the session,
*  the journey or the trip as it's called,
*  as well as initiating neuroplastic events,
...
*  as a center of mass of data that point to the fact
*  that psilocybin, when taken in the appropriate set
*  and setting, the appropriate dosages,
...
*  I hope today's discussion allowed you
*  to better understand how psychedelics
*  and psilocybin in particular,
...
*  which is, by the way, associated with the expansion
...
*  for mental health issues that to date have been very hard
*  for people to access.
*  In addition to that, I'm just fundamentally interested
*  in the brain and how it works and how it can change,
...
*  and highly trained physician needs to be very cautious
*  about these compounds as well.
*  They're very exciting.
*  I think psilocybin is an exciting
*  and super interesting compound for basic and clinical reasons
...
*  and non-classical psychedelics, including LSD, DMT,
*  5-MeO-DMT, ketamine, MDMA, mescaline,
