...
Length: 10058s
Video Keywords: ['andrew huberman', 'huberman lab podcast', 'huberman podcast', 'dr. andrew huberman', 'neuroscience', 'huberman lab', 'andrew huberman podcast', 'the huberman lab podcast', 'science podcast', 'cannabis', 'marijuana', 'effects of cannabis', 'effects of marijuana', 'THC', 'CBD', 'vaping', 'negative health effects of smoking', 'negative health effects of cannabis']
Video Views: 3022032
Video Rating: None
---

# The Effects of Cannabis (Marijuana) on the Brain & Body | Huberman Lab Podcast #92
**Andrew Huberman:** [October 03, 2022](https://www.youtube.com/watch?v=gXvuJu1kt48)
...
*  And believe it or not, nowadays there is also
*  an entire literature, meaning a scientific
*  and medicinal literature about type one,
*  type two and type three strains.
...
*  a full picture as to where cannabis and the various
...
*  in anxiety, in depression, both positive and negative effects.
*  We'll talk about sex differences in terms of women
*  versus men and how they react differently to cannabis.
*  And I would be entirely remiss if I didn't include
*  a conversation about cannabis, meaning THC, CBD,
*  hybrid strains, et cetera, in creativity
...
*  a lot of information, but I promise to make it clear
...
*  Because as it turns out, there are instances
*  that we will discuss in which the use of cannabis
...
*  And for other professions, it might be entirely inappropriate
...
*  that a significant portion of the funds raised
...
*  of zero cost to all consumers content
*  on mental health, physical health, and performance.
...
*  to do a dollar for dollar match on all funds raised
...
*  as well as to anyone out there that has issues
*  with anxiety or sort of self-regulation of any kind.
...
*  and there are a number of different good ones
...
*  and simply put my last name, Huberman,
*  and NSDR into the search function.
...
*  although I should say similar to YogaNidra,
*  which some of you are familiar with,
*  this NSDR is different than YogaNidra
...
*  how that impacted my blood glucose.
...
*  and exercise were combining to regulate this thing
*  that we call blood sugar and that's so vital to our health.
*  I think anyone that tries Levels will find
*  that you learn an immense amount about what you're doing
...
*  that there is no neural circuit or chemical in the brain
*  for being smart.
...
*  And then they'll work with you and iterate
*  to find the best formulas for you to take ongoing.
...
*  I want to emphasize that the cannabis plant contains
*  a number of different psychoactive compounds.
...
*  And what we will soon learn is that what we think of
*  as being high actually includes a number
*  of different changes in the brain and body,
...
*  has over 70, 70 different psychoactive compounds,
...
*  or intriguing mysteries about what we ought
*  to explore more.
...
*  it tends to be a taller plant, a longer stalk,
*  believe it or not,
...
*  So in other words, burning the plant
*  liberates the smoke that contains the psychoactive compounds,
...
*  The Sativa varieties tend to make people feel
*  kind of invigorated, somewhat alert.
...
*  experience a sort of head-centered,
*  high alertness, focus,
...
*  causing more of a elevated mood and a head high,
*  if you will,
...
*  and he said that Indica is often referred to as Inda couch,
...
*  is that through plant biology, plant genetics,
*  I should say,
...
*  but there's now also a description of so-called type one,
*  type two and type three strains
...
*  and type three strains of Indica, Sativa or hybrid varieties.
*  What are type one, type two and type three?
*  Well, type one, type two and type three strains
*  are strains that have varying amounts or ratios
*  of THC to CBD.
...
*  And I don't mean by an engineer tinkering away with,
*  you know, gene engineering in a kind of crisper,
*  creating mutants, but literally by hybridizing,
...
*  than lead to more in the couch, as I referred to it before,
*  pun intended, deep relaxation, reduced insomnia, et cetera.
...
*  We're going to take what we know about sativa,
*  indica, type one, type two, type three, CBD, et cetera.
*  We're just going to set that aside for a moment.
*  Why would we do that?
*  Well, we have to ask ourselves,
*  why would any of these plants,
*  why would any of these compounds, THC, CBD, sativa, indica,
*  et cetera, why would any of that
...
*  So more than one billion
*  and probably closer to two billion people consume nicotine.
...
*  if we want to be accurate, very early conception,
...
*  ah, these plant compounds are safer for us or better for us
*  or are somehow appropriate for us to ingest,
*  but that's simply not true.
*  And here I'm not saying
...
*  In the same way that the nicotinic receptors are not there
...
*  by smoking or, you know, edible, et cetera,
...
*  but they do so with thousandfold greater potency.
...
*  or CBD in or ingest orally or even transdermal or tincture
...
*  These chemical substances that everybody makes, right?
...
*  and another one, which is arachidinoid glycerol,
*  arachidinoid glycerol, which we will abbreviate 2AG.
...
*  into the gap between the pre and post synaptic neuron.
...
*  what we call retrograde lead to the presynaptic neuron,
*  binds the receptors there,
*  and changes the probability
...
*  that travel retrograde lead back to the presynaptic neuron
...
*  that a given connection between neurons will function more
*  or will function less.
*  So if you think about the communication between neurons
*  as a crosstalk, as a conversation,
*  well, the endogenous cannabinoids can dictate
*  whether or not that conversation is likely to occur
*  or not to occur.
...
*  that the endogenous cannabinoids are working
...
*  But the simple way to think about it,
*  CB1 receptors are mainly in the nervous system
*  and CB2 receptors are mainly in the body
*  and endogenous cannabinoids.
*  Again, EAE, anatomide, and 2AG,
*  arachidinoid glycerol, are impacting CB1 and CB2 receptors.
...
*  And the effects tend to last anywhere from three
*  to four hours, although there's some variation on that,
...
*  on their outside.
*  And then of course, when people say here fat,
...
*  but certainly in intravisceral fat
*  and other fatty tissue that's around the brain and body
...
*  and are immediately able to access neurons in other cells
...
*  Joke intended, but in any event,
*  there are exceptions, but there are also general rules.
...
*  and brain structures and neural circuits,
...
*  so it would tend to increase focus.
...
*  The way to think about the stress in limbic circuitry,
...
*  when they smoke sativa varieties or other varieties
*  of cannabis or ingest other varieties of cannabis.
...
*  because as I mentioned before, THC and or CBD
*  are going to bind that CB1 receptor,
*  let's say in prefrontal cortex,
*  a neurons of prefrontal cortex is going to bind there.
...
*  and causing retrograde signaling back
*  to the presynaptic neurons in the amygdala,
...
*  although I don't want to go into what flow states really are.
...
*  where people will spend some time really seeking out
...
*  And so whether or not someone gets incredible anxiety relief,
*  enhanced sense of mood and focus and wellbeing,
*  pain relief, et cetera,
...
*  and I promise very briefly,
*  I know I'm not often concise,
...
*  In general, the prefrontal cortex
*  is going to be activated by the sativa varieties,
*  which is going to increase thinking
...
*  Yeah, so there's an array of different effects.
*  And as I mentioned before,
*  CB1 receptors are present all over the nervous system
*  in the brain, the spinal cord, in fact,
*  the presence of CB1 receptors in the spinal cord
*  largely explains the fact that THC and CBD,
*  to some extent, although it's not very well studied,
*  can provide some pain relief.
*  I say some because a lot of people perceive or believe
*  that they experience more pain relief from cannabis
...
*  people are distinguishing between sativa
*  and indica strains in their patterns of use
*  and what they prefer and what they don't prefer,
...
*  that there's absolutely no way that the science could keep up.
...
*  Well, sometimes it is, but oftentimes people
*  are using cannabis in order to achieve a particular state.
...
*  you look at our progression in terms
*  of technology development and culture
...
*  First of all, we need to define creativity, right?
...
*  and kind of braiding them together, finding a common thread,
...
*  inside your own head when you are engaging
*  in convergent thinking.
*  You're thinking, well, so-and-so said this and I think that,
...
*  It's exploring ideas and continuing to move into the variation
*  in the vastness of ideas in hopes of eventually
*  being able to converge on some novel idea or framework.
*  So these are similar and related,
*  but typically the creativity process involves
*  first brainstorming and divergent thinking,
...
*  is that in professions where there's a lot
*  of creativity required in order to succeed,
...
*  It's really the idea of, you know,
*  throwing out disparate ideas, right?
...
*  or taking existing ideas
*  and arranging them in a novel way
...
*  So here using a arguably a very reductionist view,
*  we're looking at all of this thing of,
*  we're calling creativity
*  through a very neuroscience reductionist lens,
*  we can say this.
...
*  and in fact, experience a kind of a joy
*  or elation, a comfort, and a pleasure
...
*  and interesting in combining them,
...
*  They don't just drop into a trench of creativity.
...
*  of convergent thinking, which is really homing in
...
*  in these cannabis users when they were not
*  under the influence of cannabis and asked whether or not
*  their ability to be creative was enhanced by cannabis.
...
*  What I mean is this paper finds that people
*  who are more open to experience
*  are more likely to use cannabis
*  and people who use cannabis are going to be more open
*  to new experiences.
...
*  will be enhanced by openness and by reduced levels
*  of anxiety, so a willingness to explore different options,
...
*  So I'd like to discuss now whether or not
*  cannabis can impact patterns of speech,
...
*  And then of course, some of you out there
...
*  to arrange one's cannabis use, everything from zero,
*  none at all, to constantly every day, all day,
...
*  or consuming marijuana by edible
*  changes one's speech and does it in a very specific way.
*  And in this study by Adam Vogel and colleagues,
*  they explored a huge different variety
*  of aspects of speech.
*  And this can be done using spectral processing,
*  which is, you know, fancy nerd speak
...
*  Can that's fancy nerd speak for vocal effort and intensity?
...
*  and appeared to change in line with the duration
*  of abstinence from cannabis use.
...
*  So rather than emphasize particular words
*  within a sentence,
...
*  with approximately 4% of adults age 15 to 64 years
...
*  with approximately 4% of adults age 15 to 64 years
*  reporting recent use.
*  And the citation comes from the United Nations Office
*  on Drugs and Crime 2019.
...
*  there's an entire literature on inspiratory,
*  inhaling versus expiratory laughs.
...
*  And his lab and him are expert
*  in the study of neuroscience controlling language
*  and speech.
...
*  whether or not cannabis can increase sexual activity,
...
*  the only chemicals and neural circuits involved
...
*  In fact, they experienced suppression of sexual desire.
...
*  if it was males or females, because they looked at both,
...
*  So this, I believe, resolves a long-standing controversy
...
*  It was whether or not people's prolactin levels
*  went up or did not go up
*  that predicted whether or not their levels of arousal
*  would go up or not.
...
*  well, then it's very likely that cannabis
...
*  when under the influence of cannabis,
*  it's very likely the cannabis is increasing
*  your levels of prolactin.
...
*  Yes, there are a subset of individuals for which that's true,
...
*  This is actually what creates the so-called
*  refractory period for males during which
*  they cannot achieve erection again for some period of time.
*  That relates directly to how long the prolactin increase lasts.
...
*  and circuits in the brain and body such that when tending
...
*  who's been on this podcast before, but he verified that
*  in my read of the literature is that the edible forms
*  of marijuana, cannabis, probably again,
*  let's put an asterisk next to this,
*  but it appears do not have as much of a prolactin
*  elevating effect and therefore not as much
*  of a dopamine suppressive effect and therefore not as much
...
*  And keep in mind that testosterone in females is vital
*  for libido and cognitive function, cellular repair, et cetera.
...
*  If you think about it, someone has to come
*  into the laboratory and let's say you want to study
...
*  to the next of how much cannabis and THC they're bringing
*  into their system.
...
*  And no joke here, especially if marijuana is impacting
...
*  because it is a stimulant, at least when initially
*  brought into the system, even if it might eventually
*  lead to relaxation.
*  So now you've got someone who's anxious
*  or somebody who's not anxious, is deeply relaxed
...
*  Now you can probably appreciate better as to why there's
*  so little nuanced data about sativa versus indica
...
*  Smoking marijuana chronically, meaning more than twice
*  a week does appear to reduce testosterone significantly
*  and elevate so-called aromatase enzymes,
*  which are the enzymes that convert testosterone
*  into estrogen.
*  This might partially explain the effect that occurs
*  in about 35% of males, which is gynecomastia,
*  which is a development of breast tissue in males,
*  in particular, young males who have elevated levels
*  of testosterone or who are taking exogenous testosterone
...
*  or that they have very low levels of aromatase
*  in their system.
...
*  but can be associated with elevated levels of,
...
*  the effects on testosterone,
*  meaning at least most studies point to reduced levels
*  of testosterone and increased estrogen,
...
*  caused by cannabis use, reduced levels of LH,
...
*  marijuana in cannabis reduces GnRH,
...
*  to support normal ovarian function in health
*  and normal testicular function in health,
...
*  And in both cases, if we just set aside
*  the direct effects of tobacco
...
*  the two receptors for cannabis to which THC, NCBD and CBN,
*  and all other psychoactive compounds of cannabis
*  bind to, to have their actions,
*  are present throughout development.
*  Believe it or not,
...
*  They are present and active in adolescence.
...
*  in the United States showed that 15%, 1.5,
...
*  ingestion of an edible to increase THC and or CBD
*  during pregnancy, which to me, I have to say,
...
*  of pregnant mothers using cannabis at some point
*  during pregnancy and maybe even frequently
*  throughout pregnancy.
*  And the effects on the developing fetus
*  are completely unknown, but recall that cannabis
*  and THC and CBD outcompete,
*  meaning they park in the receptor
*  for endogenous cannabinoids and prevent endogenous
*  cannabinoids from having their normal level
...
*  and any related compounds in cannabis, edible or smoked,
*  certainly not smoked, but even edible during pregnancy.
...
*  It's certainly legal in the U.S.,
...
*  and cannabis that smoked or vaped
...
*  which again is not to say that there are not positive effects
...
*  So while some receptors in the brain and body are such that
*  when something, a chemical binds to them,
...
*  in the downstream signaling mechanism
...
*  the so-called decrease in anxiety, increase focus,
*  increase creativity, some of that starts to wane.
*  It starts to dissipate and people wonder why they have
*  to use so much cannabis just to achieve a fraction
*  of the effect that they used to be able to achieve
...
*  or changing the pattern of delivery from, you know,
*  smoking to vaping or from vaping to edible
*  and from edible to transdermal.
...
*  So that's serious.
*  In fact, we now know based on really solid
*  epidemiological evidence that depression
*  is not a strong predictor of seeking out cannabis.
...
*  and here's why it's a really serious concern.
...
*  there are downstream effects on the signaling
*  within those cells that all the data point
*  to creating a much, much higher likelihood
*  of developing major depression, severe anxiety,
*  or psychosis at later ages.
*  So to be very clear, cannabis use between the ages
*  of 16 to 24 in both males and females
*  is increasing anxiety, increasing depression
*  in the immediate years and within the one year's time
*  or so, so much so that people are using cannabis ongoing
*  in an attempt to reduce that anxiety
*  and reduce that depression, but in addition to that,
*  the cannabis use,
...
*  and this is completely aside from any so-called
*  positive effects or beneficial effects of cannabis
*  that people might derive from occasional use as adults,
*  meaning people older than 25.
*  So for the person who's older than 25,
*  who eats inedible every once in a while,
...
*  the effects of cannabis and other drug use during adolescence.
...
*  what that represents to you, healthy metabolic function
*  and weight, et cetera.
*  Those are all going to facilitate some recovery
*  of brain function, in particular,
*  prefrontal cortical function by way of all the positive
*  effects that those behaviors and choices have.
*  But with that said, if you are in the age bracket
*  that I've been referring to, this 14 to 25 year old
*  age bracket and you are a occasional even
*  or chronic cannabis user, you should be very, very careful
*  and concerned about the long-term effects
...
*  in which nowadays we are hearing, yes, it's becoming legal
*  in a number of areas.
*  And we talked earlier about why that's probably a good thing
*  in most circumstances, but that we aren't just hearing
*  that cannabis is safe or it's not just being implied
*  that cannabis is safer, but many more people are talking
...
*  some people out there because I know that there are a number
*  of people who fought very hard for the legalization process
...
*  than it is for a young person, age 14 to 25,
...
*  of this neural circuitry that we've been talking about
*  up until now.
*  And it's abundantly clear that cannabis and THC
*  in particular dramatically disrupt those processes.
...
*  I don't think that was an intentional sweeping away.
...
*  and really pulls the consistent messages that are arriving
*  from all these different studies.
*  And as they point out, and again, I'm paraphrasing here,
*  this is the first systematic review of the association
*  of cannabis potency.
...
*  of cannabis use to zero ideally, or to very low frequency,
*  very low potency in adolescents and teens
*  and people aged 25 or younger.
...
*  in people suffering from cancer chemotherapy.
...
*  and the fact that so many pregnant and lactating mothers
*  are using cannabis.
*  I mean, that number 15% still has me,
*  dizzy with kind of disbelief
...
*  and other types of major psychiatric disorders later in life.
...
*  by going to hubermanlab.com slash premium.
*  They're for $10 a month or $100 for the entire year.
...
*  with Momentous on, you can go to Live Momentous spelled O-U-S,
