...
Length: 8329s
Video Keywords: ['andrew huberman', 'huberman lab podcast', 'huberman podcast', 'dr. andrew huberman', 'neuroscience', 'huberman lab', 'andrew huberman podcast', 'the huberman lab podcast', 'science podcast', 'breathing', 'breathwork', 'breathing practices', 'breathwork practices', 'stress reduction']
Video Views: 1089890
Video Rating: None
---

# How to Breathe Correctly for Optimal Health, Mood, Learning & Performance | Huberman Lab Podcast
**Andrew Huberman:** [February 20, 2023](https://www.youtube.com/watch?v=x4m_PdFbu-s)
...
*  There's a spasm of that neural circuit,
...
*  and how it interfaces with the other organs and tissues
*  of the body, in particular the brain.
*  In fact, one of the most important things to understand
*  about breathing right here at the outset
...
*  In fact, much of today's discussion will also center around
*  the common misconception that carbon dioxide
*  is something that we want to get rid of.
...
*  as mechanical mechanisms or chemical mechanisms.
*  What do I mean by that?
...
*  and actually performs during sleep on a regular basis
...
*  and they are blowing off
*  or removing too much carbon dioxide.
...
*  to the tissues of the body, in particular, their brain.
*  And this is true not just for people
*  who are obese or who suffer from sleep apnea,
...
*  in positive ways that allow anyone to show up
*  to the various social and non-social endeavors
*  of their life with more calm, more focus, alertness,
...
*  the incredible advantages of being a nasal breather
*  most of the time,
...
*  because what we will soon learn is that
*  your lungs basically act like a pump.
...
*  that inside of them have hundreds of millions of little sacs
*  that are called the avioli of the lungs.
...
*  and that allows your rib cage to move up and to expand a bit.
...
*  So we've got the nose, the mouth, the larynx, and the lungs.
*  The lungs have all those little avioli in them.
*  And as I told you, we've got the diaphragm as a muscle
*  to move the lungs, and we have the intercostal muscles
*  to move the ribs, which can allow the lungs to expand.
...
*  They go through close to the heart
*  and a little bit behind it.
...
*  frankly, you could use diaphragmatic breathing
*  or you could use rib cage type breathing
*  in order to bring enough oxygen into your system.
*  There's no real data showing that diaphragmatic breathing
*  is somehow better or worse.
...
*  breathe in through your mouth and only through your mouth
*  versus breathe in through your nose.
*  Some of you perhaps have a harder time breathing in
*  through your nose.
*  By the way, it's perfectly normal
*  that one or the other nostril would be harder to breathe
*  through or easier to breathe through
...
*  A little bit later, we'll talk about how to repair
*  a deviated septum without surgery
...
*  Oh, okay, so I can inflate my stomach doing that,
...
*  which is if you're somebody who has challenges breathing
*  in through your nose, that somehow you should avoid
*  breathing in through your nose.
*  Actually, quite the opposite is true
*  and we can go a step further and say that
*  if you have challenges breathing in through your nose,
...
*  And without carbon dioxide, you're not going
*  to get enough oxygen to the cells and tissues of your body.
...
*  And then that oxygen gets bound up by proteins in the blood,
*  in particular hemoglobin.
*  And hemoglobin then delivers oxygen to the very cells
...
*  at the level of immune system, hormone system, brain, etc.
...
*  that you're feeling more alert in the brain,
...
*  puts you into a state that's called hypocapnic, all right?
*  Hypoxia, hypoxia is reduced levels of oxygen
*  relative to normal.
*  Hypocapnia is reduced levels of carbon dioxide
*  relative to normal,
*  and is those reduced levels of carbon dioxide
...
*  I think enough people experience it that it is of interest,
...
*  at high altitudes,
*  and that can impact how much oxygen you can bring
*  into your system, into your tissues.
...
*  and hemoglobin and oxygen that allow more oxygen
...
*  combined with some breath holds that can allow you
*  to deliver more oxygen to the cells
...
*  Then when you shift from mouth to nasal breathing
*  during sleep, you're actually learning
*  and training your system to breathe properly.
...
*  By the great Jack Feldman, who's a professor
*  of neuroscience at the University of California, Los Angeles.
*  This is one of the most fundamental discoveries
*  in all of neuroscience in the last hundred years or more,
*  because this brain area that Jack
*  and his colleagues discovered controls all aspects
*  of breathing that are rhythmic.
*  That is when inhales follow exhales,
*  follow inhales, follow exhales.
*  That's all controlled by a small set of neurons
*  in this brainstem area, so in the,
*  around the region of the neck,
...
*  to be incredibly robust and are designed to fire,
*  inhale, exhale, inhale, exhale,
*  no matter if we're awake or aware, unaware,
*  or asleep to keep us alive.
*  Exogenous opioids like fentanyl
*  and drugs that are similar to that can shut down
*  that structure because it's rich with these opioid receptors.
*  So it binds to that and it shuts off
*  the pre-Bot-Singer complex, which is the major cause
*  of death of people who die from opioid overdoses.
*  I think a lot of people don't realize that they think,
*  oh, the opioids must shut off the brain
*  or shut down the heart.
*  No, it shuts down breathing.
*  So Jack's discovery, no doubt, will lead
*  to some important things as it relates to addiction.
...
*  or other types of drugs, maybe by blocking opioid receptors
*  in pre-Bot-Singer complex using things
*  like naltrexone, et cetera.
*  In any event, pre-Bot-Singer complex is controlling
*  inhale, exhale, inhale, exhale to patterns of breathing.
...
*  So inhale, pause, exhale, pause, inhale, pause,
*  exhale, pause, this sort of thing.
...
*  that is relying on the pre-Bud Singer complex neurons
...
*  because inhales, pre-seat exhales,
*  pre-seat inhales and so on,
...
*  We can also take control of the pre-Bud Singer complex.
...
*  of control of the pre-Bud Singer complex.
...
*  like pre-Bud Singer or paraphacial,
...
*  paraphacial and pre-Bud Singer, in parallel.
...
*  that you can't actually use the oxygen
*  that you have.
...
*  excitability is the threshold
*  at which a given neuron, nerve cell, can be active or not.
...
*  carbon dioxide in or rather the proper way to say it
*  would be because they're over-breathing, exhaling too much,
...
*  then hold your breath until the minute passes?
...
*  in the proper ways are also taking pauses between breaths.
*  This is extremely important
*  because even though we have a brain center,
*  the pre-Bot-Singer complex that can control,
*  or I should say does control inhale, exhale,
*  rhythmic breathing,
...
*  at detecting and learning information,
*  at focusing and so on as a consequence of this over breathing
*  and the hyper excitability that causes.
*  Now, of course, that's also just emphasizing the effects
*  of over breathing and lack of carbon dioxide on the brain.
*  There are hundreds, if not thousands of studies showing
*  that when we don't have enough carbon dioxide
...
*  I encourage you to sit down, certainly not lie down,
*  but just sit down.
...
*  Okay, now start, meaning slowly control the exhale
*  through your nose.
...
*  I'll explain what too quickly means, 30 seconds.
*  Okay, for those of you that have already reached lungs empty,
...
*  but please don't do that because that's not going to be
*  informative for what I'm telling you now.
...
*  and you feel great, that number is going to be extended, okay?
*  So this is a back of the envelope measure
*  that you're going to use each time
*  you decide to do the exercise
...
*  Box breathing are equal duration,
...
*  So that's why we do a test to see what you're capable
*  of doing.
...
*  And please also let me know how your progress evolves
*  over time with the carbon dioxide discard rate
...
*  or in some cases, fewer studies,
*  had explored how breath work can impact different brain states
...
*  our laboratory is realistic,
*  we have virtual reality and things like that,
...
*  physiological parameters, and they were also
*  informing us regularly about their subjective mood, et cetera.
...
*  memory, and a number of other things related
...
*  exhale through the mouth, repeating that for 25 cycles,
...
*  this study was not just exploring what happens
...
*  First of all, if you're somebody who wants to improve
*  your mood and reduce your overall levels of stress,
...
*  extended exhale through the mouth until your lungs are empty,
...
*  The physiological sigh has some other
...
*  chances are, despite what your high school PE coach
*  told you, that raising your arms above your head
...
*  That's right, when you contract your diaphragm,
...
*  All right, and the converse is also true, of course.
...
*  Now this feature, which physicians call
*  respiratory sinus arrhythmia,
*  or we sometimes hear about more often nowadays
*  as heart rate variability is something that people in sport
*  have known about for a very long time.
*  It's why, for instance, that marksmen will exhale
*  just prior to taking a shot.
...
*  and they'll exhale and then they'll shoot at the target.
...
*  between the ribs, is a skill that you can very quickly
*  acquire and will allow you to use that relationship
*  between the phrenic nerve, the diaphragm,
*  the size of the heart, the heart volume,
*  and all that stuff to really take control
*  of heart rate quickly so that if you feel like
*  your heart is racing too much,
*  and frankly, a lot of people have a lot of
*  what's called interoceptive awareness,
*  especially anxious people, they can really sense
*  what's going on in their body, other people less so,
...
*  and three hiccups in a row is where it starts
*  to be concerning, in part because hiccups
*  can be kind of painful, and they experience pain
*  in your gut or your lower abdomen,
*  and sometimes in your chest as well,
*  and it feels kind of intrusive, it gets in the way
*  of having conversation or just sitting there and relaxing.
...
*  The reason we get hiccups at all is because
*  we experience a spasm of the phrenic nerve.
...
*  at the motor level, it's also sensing things
...
*  or a signal rather, of a sharp kind of sensation
*  of contraction within the diaphragm,
...
*  in your brainstem that can detect when carbon dioxide levels
*  in your bloodstream reach a certain level.
...
*  and from the adrenals, right, got that backwards,
...
*  which again can be done by exhaling
*  and stopping for some period of time,
*  15, maybe even 60 seconds,
...
*  and that paraphacial nucleus takes over
*  and it's, and it's that kind of panicky mode.
*  And by simply controlling our breath,
*  again, even if it's fast, from inhale to exhale
*  and making sure that we're alternating inhales and exhales
*  rhythmically, and what you'll find is that
*  you'll be able to navigate that
*  what would otherwise be a very stressful circumstance
...
*  because of heart exercise or eating or talking,
...
*  something that you might detect
*  in the periphery of your vision or here off in the distance,
...
*  versus nasal exhalations versus mouth inhalations
*  versus exhalations.
...
*  and they were able to do that because they had some patients
...
*  you're actually less able, or I should say less efficient
*  at generating voluntary movements.
*  Now that might come as a surprise.
*  You know, until now we basically have been talking about
*  inhalation is great, almost to the point where you wonder
...
*  it was traditional Western boxing.
*  As you strike, that's where people typically do the,
*  the hi-yah laying the sort of classic karate type thing.
...
*  a forceful exhalation, keeping in mind again,
*  that inhales typically are active.
...
*  and has been beautifully described in the book called
*  Jaws, a hidden epidemic.
*  This is a book that was written by Paul Ehrlich
*  and Sandra Kahn, my colleagues
*  at Stanford School of Medicine.
*  It has an introduction and a forward from Jared Diamond
...
*  that increased resistance through the nose allows you
*  to inflate your lungs more, not less.
...
*  and delivery of nitric oxide to all the tissues
*  of your body and that dilation of the small capillaries
...
*  If you want to check out that book, Jaws,
*  Hidden Epidemics, it's a terrific read
*  and it also shows some absolutely striking pictures
*  between studies and so forth
...
*  to a nose breather.
*  These are striking examples that have been observed
*  over and over again.
...
*  Fortunately, when people switched to becoming nasal breathers,
...
*  that we talked about earlier,
*  when they switched to becoming nasal breathers by default,
*  the aesthetic changes that occur are very dramatic
*  and very favorable, including sort of elevation
*  of the eyebrows, not in an artificial sense
*  or in a kind of outrageous way,
...
*  Lee might do it during exercise,
...
*  You can also just look online before and after Jaws,
*  Hidden Epidemic,
...
*  and that really breathing is a way
...
*  and LinkedIn.
*  I should mention that on all those platforms,
...
*  in which we give summaries of podcast episodes and toolkits,
