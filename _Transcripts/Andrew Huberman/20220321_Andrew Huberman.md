...
*  of the way that your visual system is built.
...
*  is extremely metabolically demanding,
...
*  of them being sweet.
*  It has everything to do with the fact that sweetness
...
*  that there are simple substitutions and modifications
...
*  or positively impacts, I should say,
...
*  but we can't say that has to do
...
*  to how to maximize sleep.
*  What is the role of sleep in sugar metabolism,
*  sugar hunger and the way that the brain regulates
*  those things?
...
*  So in little tiny 10 second bins,
...
*  of metabolism.
*  And particular phases of sleep
...
*  due to some metabolic need that was triggered
*  by the sleep deprivation or by the poor sleep.
...
*  of particular forms of metabolism being active
...
*  in 90 minutes, so-called Eltradian cycles
...
*  to sugar metabolism
*  and the neural circuits controlling sugar metabolism,
*  but I will say this.
*  If you look at the sum total of the data on obesity
*  or on type two diabetes or on metabolic syndromes
*  of any kind, you almost always see disruptions in sleep.
...
*  and interesting ways to regulate glucose,
...
*  deck chairs on the Titanic as sometimes described.
...
*  If you have comments and feedback or suggestions
*  for future topics and guests,
*  please leave those in the comment section on YouTube.
...
*  on Instagram or Twitter, please do so.
...
*  of the Huberman Lab podcast, I discussed supplements.
*  While supplements aren't necessary for everybody,
*  many people derive tremendous benefit from them.
*  One issue with supplements is that
...
*  That's T-H-O-R-N-E because Thorne is partnered,
*  for instance, with all the major sports teams
*  and the Mayo Clinic.
...
*  and that the quality of the ingredients they include
...
*  Also, if you navigate further into the Thorne site
...
*  for the Huberman Lab Neural Network Newsletter,
*  it's a semi-monthly newsletter
*  that includes summaries of various podcasts.
...
*  Just go to the menu.
*  You can find the signup there easily.
*  You can also see some examples of previous newsletters
