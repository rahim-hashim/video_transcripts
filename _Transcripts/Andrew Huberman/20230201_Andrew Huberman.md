...
*  how can I repeat that same quality of performance?
...
*  but are signalling in a way that registers that body fat
...
*  as we start cruising up that our cue starts going up,
*  up, up, up, up, up, up.
...
*  Put simply, can I enhance body fat loss by doing some cardio
...
*  Make sure number two, you're ingesting your food
...
*  You can actually actually ship it out of
*  the exercising muscle and ship it into
*  a non-exercising muscle and then go backwards
*  and make glucose.
*  What actually liberates hydrogen from lactate?
*  Chemically?
*  Yeah, so what liberates, well, what are the stimuli
*  that can take hydrogen off the pyruvate?
*  Yeah, oh yeah.
*  And then, in other words, to reduce lactate
*  and free up that hydrogen.
*  Oxygen availability.
*  So, in fact, one of the major places
*  that you ship hydrogen to, or one of the major places
*  that you ship lactate to is your heart
*  because this is what we call the ultimate slow-touch fiber
...
*  and now we have a place to store the hydrogen on it.
*  Right?
*  Cool, so as a result of anaerobic glycolysis,
*  we have made a little bit of ATP.
*  We've created a lot of waste and we don't have anywhere
*  to go with these end products.
...
*  and you gotta deal with the waste products.
*  Boom.
...
*  This is it, right?
*  How well can you handle the elevations in hydrogen, right?
*  Drop in pH.
...
*  you will take those things and ship them
*  into the mitochondria.
*  They have to go through some cell walls
*  and some other things like that.
*  But they're going to get inside there.
*  Once they're in there, that two carbon acetyl-CoA
*  runs through this entire cycle that we call the Krebs cycle.
...
*  and you're going to start off the top.
*  You have a bunch of fun stuff going on.
*  But as a part of that circle,
*  you're going to pull off some hydrogen ions.
...
*  And as a result, about halfway through the turn,
*  you're going to pull off one carbon
*  and about halfway through the other,
*  but almost the other way through the finish,
*  you're going to pull off the second carbon.
*  So you're going to take the second acetyl-CoA,
*  run that entire thing, same through as well.
*  And so what we did is we started off
*  with a six carbon glucose chain.
*  We split it in half.
*  We called those pyruvate.
*  Made a little bit of energy
*  because we broke that one bond
*  of those two carbons that are in the middle.
*  Cool. Those two, three carbon molecules,
*  we pulled one carbon off of each.
*  We brought in, sorry, we moved those into the mitochondria.
*  We brought one off.
*  We took a breath, brought in some oxygen, bonded that,
*  took out two CO2 exhales.
*  We ran the acetyl-CoA through the Krebs cycle.
*  One, two carbons per turn coming out as CO2.
*  So we had six carbons total as we started
*  and we exited with zero carbons.
*  Now we have fully metabolized a molecule of carbohydrate.
*  That required an anaerobic start and an aerobic finish.
*  If you don't have a lot of mitochondria,
*  large mitochondria, high functioning mitochondria,
*  you're going to limit your anaerobic performance
*  because you're going to get,
*  they're going to run that door full very, very quickly.
*  You can't go past it
*  because hydrogen will build up way too fast.
*  And one of the things that we know is both temperature
*  and pH run enzyme function.
*  So they're going to stop.
*  You won't even be able to run through, in fact,
*  that ATP hydrolysis phase.
*  Even if I gave you a whole infinite supply of ATP,
*  if I put enough acid in there, it would stop working
*  because the ATPase enzyme needed to split
*  and won't be able to run in a highly acidic environment
...
*  Correct.
*  I would have thought, given that the mitochondria
*  are the site for essentially for aerobic metabolism,
...
*  Is it not in either one?
*  No, in fact, again, I think it's better to think
*  of these things rather as two separate parallel things
*  as one big cycle.
*  They're one gear turning the next.
*  Being compromised in one will compromise the other.
*  That, I should say, reminds me of what you said earlier,
...
*  and it's the thing we need to stop and buffer
...
*  there's a really cool history on lactate,
*  but it was originally found, I think in Germany,
*  pardon my history there,
*  somewhere in Europe and hunted stags.
*  So one of the things is they sort of realized is like,
*  if we harvested a stag in a rest of state
*  when it didn't know we were there versus if we chased it
*  and it was ran down,
...
*  If you're to do any sort of lactate test,
*  any sort of metabolic test,
*  you will see as fatigue increases,
*  lactate will also increase.
*  The assumption there was then, oh my gosh, is the cause.
...
*  Lactate's fine.
*  You're actually gonna use it in, again,
*  the neighboring exercise muscle fibers in the same muscle.
...
*  Just as that fuel source,
*  or you can send it in the heart or any number of sources.
...
*  Is really an issue of managing,
...
*  of fuel sources are used depending on
*  how long I happen to be exercising.
...
*  but here I'm thinking about sprinting for one minute
*  or less.
*  Which fuels are used?
*  Is that mainly driven by fat,
*  stores by carbohydrate stores?
...
*  leading all the way up to full marathon.
*  How does that change the ratio of fuel sources
*  that are used?
*  And I'd be particularly interested in distinguishing
*  between carbohydrate, fat and protein that's ingested.
...
*  So it's not a big energy output, but it's very fast
*  because it is stored right there
*  in the local exercising muscle.
*  Right, now, if you need energy past that point,
*  say, you know, 10 or 15 seconds
*  up to maybe a couple of minutes,
...
*  to keep that up.
*  And we've sort of covered that conversation.
...
*  So more than you get from the phosphocreatine system.
*  Triple or quadruple, but still not very much.
*  There's another major downside
*  that's coming in a second to this system.
*  The upside is it's fast.
*  Now actually one adaptation we get to training in this style
...
*  So you're able to sustain the system longer.
*  So perhaps 90 seconds into your interval training,
*  you hit a fatigue point and now you maybe can extend that
*  to 100 or 115 seconds simply
*  because you're storing more glycogen in the muscle
*  before we have to end then go into the blood
...
*  regardless of where they come in can follow me here.
*  So don't burn me on the details.
*  You've got this pyruvate.
*  The problem is you can no longer do anything
*  with that glycolysis is over.
*  You've got to make a choice.
*  In order to make something out of those three
*  carbon molecules, you've got to ship them
*  to the mitochondria.
*  As we said, that is the only place of aerobic metabolism.
*  We cannot do aerobic metabolism anywhere else
...
*  you have to now do something with that carbon waste.
*  Okay, so before when we split the six carbon chain,
...
*  because that's going to increase acidity level.
*  Any enzyme in our body that works to create fuel
*  is very pH sensitive, right?
*  So if pH gets off either high or low,
...
*  of the muscle contraction, but that's what we're after, okay?
*  So in the case of pyruvate, if we split that off,
*  we have got to deal with that.
...
*  and make CO2, we're going to exhale that thing out.
...
*  In doing that, remember ATP is a adenosine molecule
...
*  that's where you get your energene.
*  So now you have an inorganic phosphate and an ADP,
...
*  And so, oh, we're building up acid.
*  We have building up pyruvate.
*  We know of nowhere to go with it.
...
*  A pyruvate that's holding an extra acid has a special name
*  and we call that lactate, all right?
...
*  you can bring in the oxygen, attach it to that hydrogen,
*  make water, and now you're right back to pyruvate.
...
*  through this fancy thing called the Corey cycle,
...
*  if you do a 20-minute bout of exercise prior
*  to taking the exam.
*  And it's largely, in part, probably because of things
*  like elevations and lactate.
...
*  arrive to the discussion about lactate with.
*  What happens when the bout of exercise extends longer?
*  Amazing.
*  So if we wanna continue past that point,
*  we have to have some sort of strategy to get through it.
*  We're stuck, we're out of gas.
*  We have to then ship it to the mitochondria
*  and now we're gonna enter what's called
*  aerobic glycolysis and this is gonna take us
*  anywhere from again, say that 90 seconds of all that work
...
*  and things like that now, but traditionally,
*  most endurance folks are gonna buy us
*  heavily towards carbohydrate.
*  Now, in one respect, you're not going to run
*  out of carbohydrates until you're many hours in.
...
*  You're gonna be limited by some other things,
*  which we'll maybe sort of break down here in a second,
*  but you're gonna be fine there.
...
*  where there's like 100 people waiting to go
...
*  I suggest people do exactly what you describe also
*  for any kind of cognitive testing.
*  Of course.
*  Before a big exam is not the time to discover
*  whether or not you can handle twice as much espresso
*  or take a nootropic for the first time.
*  Or change anything.
*  I mean, if indeed the score on that exam
*  is meaningful to you, you keep things regular.
*  So to recap what we've done here
*  is we started off in the cytoplasm
*  with this glucose molecule that is six carbons.
...
*  water, and CO2.
*  Beautiful.
*  And leads me to the conclusion that most everything
*  is really about utilization of carbons and exhaling CO2.
...
*  and within the mitochondria specifically,
*  and then carbon dioxide to be exhaled
*  as we work through the carbons
*  or the sort of beads on a string.
*  Is that right?
*  Unless you're moving incredibly fast for a very long time,
...
*  or getting more efficient and having a higher capacity
*  for our anaerobic side.
...
*  and then train according to that or do your strategy,
*  your nutrition, your supplementation
*  that defeats that limiting factor.
*  For example, if you are trying to maximize your performance
*  in this 20 second maximal burst
*  and your strategy for that was to make sure
*  that your muscle glycogen is saturated,
*  it's probably not gonna help a ton
...
*  in terms of if you did a several hour bout of exercise.
*  When you started doing it,
*  you might be using 5% of your energy from protein
*  and then that might grow to 10 or so.
*  And that happens because you start running low
*  on muscle glycogen,
...
*  When I say oxidized, you use oxygen
*  to burn something to make a fuel.
*  So it's not a significant contributor to energy
*  in that regard.
*  And unless you're talking ultra marathons or longer,
*  and it is also not something that can enhance performance.
*  And so we don't really need to talk much more about it
*  than that.
...
*  which is why somebody who loses fat loses it
...
*  cleave off one carbon, run it into its acetyl-CoA,
*  bada bing, bada boom.
*  Exact same thing.
...
*  or even a medium chain, tricloseride,
*  which a lot of folks have heard of MCT,
...
*  Remember, the final endpoint
*  of carbohydrate metabolism is water, ATP, and CO2.
...
*  So if you're like, man, mentally I don't have it in me today
*  to get to a high heart rate and throw up and all that stuff,
*  cool, but you can just do some moderate steady-state stuff,
*  well, that's a win, great.
...
*  I gotta get this done in eight minutes, great.
*  Go do some high-intensity intervals.
...
*  I often hear from people that they prefer
*  one type of exercise versus another for sake of fat loss
...
*  and I exercise outside of that.
...
*  and then they are quote unquote
*  not hungry for several hours afterwards.
*  Does that have anything to do with which fuels
*  are being utilized during different forms of exercise?
...
*  man, if I do this type of training,
*  then I just am exhausted and I lay around
*  the rest of the day.
*  So my total caloric expenditure is actually compromised
*  as an aggregate because I'm down.
...
*  and maybe those differences are important
...
*  We brought some newspaper and then we brought a match
*  and we need to create a fire.
...
*  it is more energy than you get in a match,
*  but you still, I don't know,
*  what's it gonna take, a few minutes,
*  some number of minutes before an entire newspaper burns up?
*  Yeah, five, I don't know, right?
*  Depends on them.
*  Which type of newspaper it is, I guess, right?
*  Amazing.
...
*  it could last hours, days.
*  It's really quite unlimited.
*  Your fossil creating storage is very limited.
*  It's small.
...
*  170 pounds or so, and you're moderately lean,
*  maybe 15% body fat, nothing crazy.
*  You probably have enough stored fat
*  to create enough energy to survive for more than 30 days.
*  This would literally be, if you ingested zero calories,
*  you would have enough fuel in your stored fat
...
*  what limits my performance in these areas,
...
*  I've gotta mobilize it.
*  I've gotta get it in the blood, move it, that whole thing.
*  Too slow.
...
*  You have to burn, burn, burn, burn, burn.
...
*  I would probably look at you like you're crazy.
...
*  where there's ever gonna be anymore.
...
*  from protein, make glucose from it.
*  It's just very poor.
...
*  and you're wondering why you're just slugging it down,
*  well, what you've done is you've downregulated the ability,
*  literally the enzymes responsible
*  for that entire anaerobic glycolysis portion,
*  they get downregulated,
...
*  severely limiting or completely eliminating carbohydrate.
*  And after about two or three days,
*  I feel pretty lousy,
*  but mostly because I want to train very intensely
*  in the gym.
*  In addition to doing longer runs,
*  I tend to do all of those things across the week.
*  Yeah.
*  But I've also observed, and in fact,
*  know several people that love the very low-carbohydrate,
...
*  I guess one of the things I want to point out is
*  this should be received as, again,
...
*  but that were covered in the episode that we did
*  on strength, speed, and hypertrophy.
*  So just to remind people, the nine adaptations
*  are number one, skill and technique,
...
*  And just to remind me what fuel sources
*  are predominating when I'm training
*  for muscular endurance.
*  Great, so remember, muscular endurance is something
*  that's going to be generally in a local muscle.
...
*  So this is the classic example we give here
...
*  A plank, a wall sit.
*  Great, yes, love all these things, okay?
*  Now, the reason I took you on that big,
*  long metabolism journey is so I could help you
*  understand exactly how to train this factor
*  or any of these factors with a more comprehensive
*  understanding of what's happening.
*  Meaning, thinking back to metabolism,
...
*  or your glutes than you are with a small muscle group.
...
*  after hard exercise.
*  Great.
*  So the reason I'm laughing because I don't think
*  I've ever thrown up from a weight training session,
*  and so it's making me wonder if I've ever trained that hard.
*  I received or obtained the progress
...
*  Plenty of fuel.
*  You manage acid buildup,
*  and you also need to get that fuel out of you.
*  That's gonna be a capillarization issue.
*  So the way that we can think about this is,
*  capillaries surround your muscle,
*  and the whole point of them is so that
*  blood can come into them.
...
*  So what are strategies to increase
*  acid buffering ability and then capillarization?
...
*  I find it remarkable, although not surprising,
...
*  In any event, what I'm hearing is,
*  building more capillaries
...
*  in terms of the classic Galpin lists now
*  of exercise choice, maybe a few options,
...
*  If you wanna do more pushups, do more pushups.
...
*  And so if you, I guess, theoretically wanted
*  to maximize your pushup number,
*  and you did a whole bunch of, say, split squats,
*  and you just did those,
*  and you did lunges for a mile or something like that,
*  you might actually slightly compromise, you might not,
*  but you might slightly compromise your ability
*  to do as many pullups in a row,
*  or hold a bent over row or something like that.
*  So if you really cared about that level,
*  then you maybe wanna do the thing
...
*  of your one rep max,
*  you don't really need to train much more than 50,
*  maybe 55 or 60% of your one rep max.
...
*  So again, if the target is doing more pullups,
*  and assuming that you have the strength to do it,
*  you check that box,
*  you simply need to practice the repetition range
...
*  So if you wanna do two days a week,
*  and you say wanted to do,
*  let's say you could do 25 pushups,
*  and the goal is to get to 30 pushups,
*  just as an example.
...
*  I'm gonna do a set basically to failure.
*  I'm gonna recover and do one or two sets that say 80%,
...
*  Do wanna emphasize that,
*  so we mentioned pullups.
*  If you can't get 25 pullups,
*  then, and you're doing 10,
*  you're training for hypertrophy.
*  You're not training for muscular endurance per se.
*  Or remember, there's a big crossover here.
*  So anytime we're talking past 15 reps,
...
*  So for people who are like, oh my gosh,
*  every time I lift weights, I blow up,
*  I go lighter, I do more reps,
*  and you're still right in the hypertrophy zone.
...
*  The only switch I would make there
...
*  is progression, and this is very simple.
...
*  Or for wall sits and planks, that would mean add time.
*  Time, yep.
...
*  meaning what is the structural or cellular adaptation
*  that are occurring that allow for increases
...
*  Yeah, so this is really, really fun.
...
*  Yeah.
*  Tabata's 30 on, 30 off, things like this.
...
*  Well, if it's a single bout or a two or three bouts,
*  probably not.
...
*  the entire thing lasts so long, it is primarily aerobic.
...
*  becomes a problem because not only are you having
*  so much buildup for such a long time,
...
*  This is not.
*  If you're doing these intervals, you're on an assault bike,
*  you're sprinting up a hill, you're grappling with somebody,
...
*  So if you wanna get better at sprinting the straightaways
...
*  We tend to call this cardiac output training.
*  You can think of this as anywhere between zone two
*  to zone four if you like zones.
...
*  You also mentioned that you don't necessarily
...
*  But maybe you could give us a sense of the breathing patterns
*  associated with each of the zones
*  so that people could map to those
*  when we discuss zone one through five.
*  And as I say all this, I certainly tip my hat
*  to all of those people out there
*  who like to measure percent of maximum heart rate.
...
*  tell me how you think about zone one through five
*  and how people might be able to assess
*  whether or not they are in zone one, two, three,
*  or four, or five.
*  Great.
...
*  Not that it's fake, but there's no rationale there.
*  It's a little bit like perceived effort in weightlifting.
*  Are you at 100% output or 70%?
*  You know when you're at zero,
*  and you know when you're at 100 in that moment,
...
*  If you're a very highly trained,
*  particularly cyclist, things like that,
*  then you can control a lot of circumstances.
...
*  Thank you, Brian, you gave me the permission to stop.
*  Brian's a good friend of ours,
*  and I do think the breathing gear system
*  is a terrific way to think about the zones
*  and to get a good sense of what zone one happens to be in.
*  Yeah, great.
*  So the first gear is your ability to simply breathe
*  in and out through your nose at a set cadence.
...
*  you're out on a longer hike, you're enjoying the day,
*  you shouldn't be trying to ramp up carbohydrate metabolism.
*  It should be efficient.
*  So this would be getting into an argument with somebody
*  while on a long walk, you feel exhausted afterwards,
...
*  inhaling and exhaling at whatever rate you need it to be,
*  but still nasal only.
*  So it is a forced,
*  right?
...
*  But the classic one people will do is
*  into the nose, out through the mouth.
*  Again, I really don't even care about the distinction.
*  I basically jump from two to four.
*  Brian may do it differently, I don't actually know.
...
*  The gear system's just one to four.
*  There's no fifth gear.
*  Got it.
*  So the gear four would again be mouth-mouth.
...
*  I also am reminded if anyone wants to experience
*  the relationship between breathing
*  and the offloading of carbon dioxide
...
*  It also becomes very hard to coordinate your action
...
*  as a result of it.
*  But the CO2 tolerance test is a test
...
*  rather than an inner reaction.
*  There are interesting data looking at things
*  like out of the blue panic attacks.
*  You can actually notice those in blood via rises in CO2
*  up to 45 minutes prior to the event happening.
...
*  And even if we're specifically just talking
...
*  So returning to anaerobic capacity.
...
*  meaning I will do one minute, then take some rest
...
*  because that was really at least what felt to me,
*  100% output.
...
*  Choice of exercises trained for what you want to improve.
*  Is that right?
*  Not necessarily.
*  So in this particular case, if you have a specific goal,
*  yes, of course, do it.
...
*  Okay, so if you're not comfortable running,
*  don't go run here.
*  You're never going to get to the spot we need to get to it.
*  If you're not comfortable or if every time you go on a rower,
*  your low back hurts the next day, don't do it.
*  If you're not comfortable using kettlebell swing,
*  you get the point.
*  Don't do an exercise you're not comfortable with.
*  You also secondarily want to be careful
*  and cautious of heavy eccentric loads
...
*  but now you're, again, too many things are going
*  in your mind.
*  I don't want to slip and fall.
*  I don't want to smash my shin on the box.
*  What happens if I'm, too many variables.
*  Pick something that is safer where you can really focus
*  on your breathing and your posture and the performance.
*  All right, so that's exercise choice.
*  And then within that, if there's some specific thing
*  you want to get better at, go ahead and do it.
*  Okay.
*  How many different movements, meaning should I do
*  the assault bike and then some form of safe,
*  executable overhead pressing?
...
*  The VersaClimber, that's the one, the VersaClimber.
*  You can tell how often I do that one.
*  That's a great piece of exercise equipment.
...
*  swimming, these things like that are going to be good.
...
*  Yep, and the consequences of a technical breakdown
*  are minimal.
*  It's more like you're going to actually have
*  a worse performance rather than an injury rate.
...
*  and then you could do some swimming another day.
...
*  unless they are really coordinated
*  or an excellent athlete.
*  I think most people can probably find a hill
*  that they could run up and an air dyne or a salt bike,
*  a rower, things of that sort.
*  Yep, you're going to have a pro and a con here.
...
*  And so you end up in this like, you burn some calories,
*  you probably still enhance mitochondrial biogenesis
...
*  how many sets per week, it's really hard to give a number
*  unlike the strength training stuff where it was easy
*  to kind of land some stuff on.
*  A typical thing you'll see is like a minimum build
*  tends to be something like four rounds per day,
*  three times per week.
*  Wow, that's a lot.
*  So my once a week, all out effort
*  of sprinting on the assault bike,
*  the so-called air dyne bike for 60 seconds,
...
*  It challenges you in that 20 second chip,
*  but you'll be recovered and fine.
*  A three minute thing is gonna hurt
...
*  So a couple of things to play with would be
*  something like this.
...
*  all out one minute sprints on one workout separated
*  by a minute or two, maybe more.
...
*  on high intensity interval stuff.
...
*  And one of the classic studies
...
*  might be like this six minute workout or something.
*  And so you like may have nailed that directly on the head.
*  Purely by luck, but actually by-
*  I also may be wrong on that number
*  so we should probably fact check that.
*  Well, and also by inference from what you were saying,
...
*  all the way up to one minute
*  by the necessary rest in order to recover my breathing,
...
*  to get on the assault bike for one minute of kind of warmup,
*  very low intensity each morning.
...
*  So you can do this at any duration.
*  You can do this for any duration of time,
*  but two minutes is a good number.
*  Okay.
*  So you have to do this in somewhere where you can,
*  no distance.
...
*  So if it took you two minutes and five seconds in round two,
*  now round three is going to last two minutes and five seconds.
...
*  5% or so every week, or you can add a round,
...
*  So you'll add a round until you get up to say six or seven
*  or eight rounds at the end of the protocol.
*  So that's a really nice way to go about it.
*  Or you can cap the rounds and just try to get more work done
*  in that same amount of time.
*  Meaning go more intensely.
*  Correct.
*  Get further distance in your 30 seconds
...
*  Now I won't be working on my ability to handle
*  the waste product build up there,
*  but I'll be working on my ability to produce more force
*  over that time, which is another skill set.
*  And then all the way up to say what you do,
*  a minute, 70 seconds, and you can go one to one there,
*  or up to three to one.
*  You're going to be working on a little bit
*  of his different thing,
*  but that's exactly how he hit both sides of this equation,
...
*  Let's talk about the specific protocols and adaptations
*  related to maximum aerobic output,
*  or maximum aerobic capacity, as it's sometimes called.
*  Sure.
*  Now we're moving past that couple of minute range
*  into the five to 15 minute range,
...
*  We're just hedging a little bit more
...
*  because we have had more time to clear waste.
...
*  at that exact same.
*  So a classic thing here is a one-mile test.
...
*  we're done here.
*  Exercise choice, same thing we talked about.
...
*  pick up another one.
*  You want to be doing something where there is literally
*  not a second of off switch.
...
*  I'm not sure what the swimming distance equivalence would be,
*  but swimmers would do this constantly.
*  But you don't need to.
*  This is really hard.
*  It's pretty hard in the system.
*  It's very good for you.
*  One to twice a week of hitting this,
*  I think you'll be in a really, really good spot.
...
*  of your heart rate, but higher than quote unquote zone two.
*  You got to be working here.
*  This is not, I could have a conversation pace.
*  This is higher than that.
*  It's in between conversation pace and the pace I need to be
*  at to run my fastest mile I've ever done.
*  That's that middle ground.
*  And you need to train that so that you can continue
*  to work on capitalization, oxygen transportation,
*  but you're not burning down the house,
*  getting all the way up to 100,
*  100 plus percent of your VO2 max.
*  Could I use a crude version of this where I say,
*  okay, I'm going to exercise for 10 minutes.
...
*  Probably not.
*  If you want to-
*  Is it okay to do after a strength training
*  or hypertrophy workout, as long as I didn't train legs?
*  You could.
...
*  I'm not sure you would do there
*  because again, especially if you did any sort of
*  lower body exercise, you're going to be compromised here.
...
*  Sure.
*  How far, how long, how fast or how slow rather,
*  should I go?
*  And here I'm going to venture that exercise choice
*  is one that we could click off even at this point
*  in the discussion because obviously it's got to be something
*  that I can do for a long while without getting injured.
*  Overuse injuries.
...
*  cycling or swimming is you can do a really cool workout,
*  any number of things where you can put
*  a little circuit together.
*  As long as there's not a lot of downtime
...
*  maybe body weight squats for two minutes.
...
*  and not feel like you're doing, oh my gosh,
*  this mind numbing type of training
...
*  three machines.
*  So you're gonna go, I'm gonna go 10 minutes on the rower
*  and I'm gonna go 10 minutes on the treadmill
*  and I'm gonna go 10 minutes on the bike.
*  You can actually knock a 30 minute,
*  quote unquote steady state session out in
...
*  and you're gonna squat and you're gonna do,
*  maybe a minute, you're gonna put that down
*  and then you're gonna go over and do 50% of a bench press.
*  You're gonna put that down, you're gonna go over
*  and do 50% of a crab walk
*  and then you're gonna go over and do another one
*  and you can actually run through this entire thing.
*  You don't hit that many reps in any individual movement,
*  the load is very, very light
*  and you can keep heart rate basically at a steady state
*  and do 15 or 20 or 30 different exercises
...
*  and I like moving through space
...
*  but fat burning system and yet I do have a question
*  which is can you build enhanced micro capillary systems
*  into the muscles by doing this long duration cardio?
*  Yeah, absolutely can.
*  In fact, depending on which paper you like more
*  than the other papers, you may even find evidence
*  that this is a superior method than anything else.
...
*  that we haven't really talked about is now we're actually
*  reaching a position where fatigue of the intercostal
*  starts to play.
...
*  and you're squeezing to contract the blow air out.
*  You're going to get fatigued, that system, right?
*  Over time, you have contracted, contracted, open up.
...
*  but not really these for huge issues.
...
*  unless again, that duration really gets generally
*  past two hours for most people.
...
*  and they quote unquote fail,
*  are they finished?
*  That's generally because we saw a massive
*  technical breakdown.
*  You're done.
...
*  and all of a sudden posture starts to hunching over,
*  I may stop the training.
*  It's like no.
*  What we decided failure was is when you lost your technique
...
*  that breathing harder than I would be
...
*  and that it would weave in well with any resistance training
...
*  So it's not that big a deal to do this
*  on your quote unquote off day.
*  If you're that type of person who like even on your off day,
*  you have to do something physical,
*  this is fine, right?
*  If you wanted to do it on a lifting day,
*  especially if it's a power strength day, it's probably fine.
*  If you wanted to do it before the workout or after it,
*  either way, you're probably okay.
*  Probably best to do it after
*  if the primary goal is one of the strength training
*  adaptations.
...
*  will help the down regulation go.
*  And so you could finish that fairly well
*  down regulated actually.
...
*  And by the time you finish, maybe even on a three minute
*  walk.
*  Nice, slow nasal breathing.
*  A four second inhale,
*  four second inhale, maybe five.
*  You can play with the numbers a little bit.
*  Then maybe you don't even need to do the down regulation
*  breathing afterwards.
*  You'll be in a good spot.
*  Well, you wouldn't want to do this before.
*  Do your intervals, finish your intervals, throw up,
*  lay on the ground, sweat all over the gym floor,
*  get up and go back to work.
*  That's probably not our best strategy.
*  As people are hearing this all, they may be thinking,
*  wow, this is a lot of work to do,
*  but I've been keeping track of the math.
*  So I'm sure some of you out there are as well.
*  And we're really talking about 10 minutes of running
*  or sprinting on the bike or rower once a week.
*  We're talking about six minutes or so
*  of the much higher intensity,
*  but short bouts divided into rounds of 20 seconds
...
*  That wasn't trying to cheat there.
*  There's some muscular endurance thrown in as well.
...
*  and long duration,
*  and given that all of that,
*  it's gonna take roughly two hours for the typical person,
...
*  Am I going to have a well-developed,
*  fat burning, carbohydrate burning system?
...
*  to enhance blood flow, increase oxygenation,
*  and manage fatigue and waste development.
*  Boom, energy's there, fatigue is there.
*  I'm not gonna get tired or have to quit or stop or sit down
*  doing any of these activities I want.
*  At the same time, if you look at the literature on mortality,
*  one of the strongest predictors
*  of how long you're going to live is your VO2 max.
*  So we've set up a scenario in which
*  you're going to hit all three of those primary goals
...
*  And as I understand, totally compatible
*  with strength and hypertrophy training,
...
*  but the ability to go a given distance at a higher speed
*  and to do it with better form and to breathe better
*  and to feel better before, during, and after.
*  For those folks, maybe you could spell out a program
*  that combines these different elements of endurance
*  and does so in a way that informs how, for instance,
*  the higher intensity short duration sprints
*  would be expected to improve their longer duration work
*  and how perhaps their longer duration work can progress
*  if they are careful to include some planks
*  and some wall sets and things of that sort.
...
*  So in this case, your feet need to be able to handle
*  13 miles of pounding.
...
*  Okay, so in addition, we talked about how even training
*  in that 70 to 85% heart rate zone is quite effective
*  at oxygen delivery, fat utilization,
*  capitalization, et cetera.
*  So you're going to get a lot of direct endurance benefits
*  from that work.
*  You're also going to be working on what's honestly going
*  to be one of your limiting factors,
...
*  It's not extremely demanding and challenging, awesome.
*  That leaves you in another 30 or 40% of training.
*  I would spend 10% of that in that like 20 second burst area.
...
*  All right, great.
*  I would spend the remaining amount of time either
*  on a little bit of actually maximum speed stuff.
*  That could actually be in the 20 second burst.
...
*  or maybe around two hours or so, something like that.
...
*  That's honestly is very similar
*  to what we laid out in the previous conversation,
...
*  and just sort of saying, I'm gonna run five miles,
*  this was weak and then do six miles next week and seven.
...
*  I realize that those structures
*  vary tremendously different coaches
*  and different folks in different programs are gonna say,
...
*  of supporting work.
*  How should one thing about distributing that other 30%,
...
*  my schedule is tight, I can pull off four to five.
*  Okay, great.
*  What I might say is two of those days
*  are just your tempo, right?
*  This is what like a runner would call this
*  like tempo training kind of in that space.
...
*  and rate that you're gonna run your race at,
*  maybe a little bit lower, but something similar.
*  You're practicing skill, you're accruing mileage
*  and you're getting work in for sure work,
*  but it's not absolutely the fastest you can sprint.
*  And it's also not conversation.
*  So this would be the,
*  what before we referred to as the 10 minutes of fast running
*  or 10 minutes of fast rowing.
*  This is lower intensity than that.
*  Got it.
*  This is work accumulation.
*  Got it.
*  This is practice stuff.
...
*  So that's probably how I break it up
...
*  This is the point in the episode where I say,
...
*  and even sub seller underpinnings
...
*  that covers all the nodes I need to if I want.
*  Everything we've talked about in these nine adaptations
