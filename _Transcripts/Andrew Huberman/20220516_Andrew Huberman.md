...
*  and said, this is a ridiculous thing to ask.
...
*  And those conditions are the ones we've been talking about
...
*  largely by the wonderful work of Susumu Tanigawa
...
*  of Mark Mayford at the Scripps Institute in UC San Diego,
...
*  or even if those neurons were played, activated,
*  that is all at once with no temporal sequence,
*  all firing in concert all at once,
*  evoked the same behavior and in some sense,
*  the same memory.
*  So at a neural circuit level, this is deja vu.
*  This is a different pattern of firing of neurons
*  in the brain leading to the same sense of what happened,
...
*  and logical explanation for what has for many decades,
*  if not hundreds of years has been described as deja vu.
...
*  in our next episode.
*  And it's just an incredible researcher.
...
*  which is a popular podcast for an equivalent amount of time,
...
*  and in fact important,
*  because most of us have heard about the positive effects
...
*  And they also, as I mentioned,
*  measured cortisol and many other things,
*  including, not surprisingly, memory
...
*  but actually impaired sleep quality compared
...
*  Most of the subjects in this study did their meditation
*  late in the day.
...
*  that I think is important many times before on this podcast,
...
*  which then logically relates to the,
*  one of the outcomes of this study,
...
*  but I think that 13 minutes a day is not actually
*  that big of a time commitment.
...
*  As you all know, very big on getting sunlight in the eyes
*  early in the day as much as one can
*  and as early as one can once the sun is out.
...
*  the more likely you are to remember whatever it is
*  that you're trying to learn.
*  And we talked about the neurochemicals
*  that explain that effect about epinephrine
*  and corticosterones like cortisol
...
*  Right, again, this can be done through behavioral protocols
...
*  All right, that was the question that we raised.
...
*  In addition, please subscribe to our podcast on Spotify
*  and on Apple.
...
*  exactly what works for you and to arrive
*  at the minimal effective dose of the various compounds
...
*  We have a very clear privacy policy that you can read there.
