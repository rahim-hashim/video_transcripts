...
*  to ensure I get all of my vitamins and minerals
...
*  but one gram of table salt contains
...
*  are the ones that you're going to be using most,
...
*  is going to be beneficial provided that it's in the context
...
*  Because remember, even if we're talking about increasing
...
*  you can just, you know, you can put into a web browser,
...
*  to function at all by disrupting this balance of sodium
*  and potassium and the amount of extracellular sodium
...
*  why dehydration leads to confusion and dizziness
...
*  that come from the brain and operate
*  at the level of the kidney in order to either retain
...
*  depending on the context in which that range
*  is being consumed.
...
*  So sodium, potassium and magnesium in the context
*  of athletic or sports performance,
...
*  or under conditions of stress, increasing salt intake,
*  provided it's done through healthy means,
*  might actually be beneficial.
*  We also talked about conditions in which
*  increasing salt intake might be beneficial
...
*  as it relates to a great number of health
...
*  And so all of us have to figure out the appropriate amount
*  of sodium intake for ourselves.
...
*  and the bodily organs interact in order to help us regulate
...
*  up to a five-star review and you can also leave us a comment.
*  The best place to leave us comments, however,
*  is on the YouTube channel.
*  There you can make suggestions about future podcast guests
*  that you'd like us to interview,
*  future podcast topics that you'd like us to cover.
*  And of course, you can give us feedback
*  about the content of this or other podcasts.
...
*  is that the quality of supplements varies tremendously
*  from one brand to the next.
*  For that reason, we've partnered with Thorne, T-H-O-R-N-E,
*  because Thorne supplements are of the absolute highest
*  quality in terms of the ingredients they include
*  and the precision of the amounts of the ingredients
*  they include, meaning what's listed on the bottle
*  is what's actually contained in that product.
*  They've partnered with all the major sports teams
*  and with the Mayo Clinic, so trust is very, very high
*  with respect to the quality of Thorne products.
*  If you'd like to see the Thorne supplements,
*  that I take, you can go to Thorne,
*  that's T-H-O-R-N-E.com slash the letter U slash Huberman,
*  and you can get 20% off any of those Thorne supplements.
...
*  that sometimes overlaps with the content of this podcast,
*  but sometimes is distinct from the content of this podcast.
*  We also have a neural network newsletter.
*  The neural network newsletter comes out once a month.
*  It is zero cost.
*  You sign up for it by providing your email.
*  We do not share your email with anybody.
*  The privacy policy is made very clear,
*  and you can sign up for the neural network newsletter
*  by going to HubermanLab.com.
*  Just go into the menu, scroll down to neural network,
*  and you can sign up.
*  And even without signing up,
*  you can access some of the previous newsletters
*  if you'd like to see what they are like.
*  We include short summaries from podcasts,
*  some key takeaways, and some resources and tools
