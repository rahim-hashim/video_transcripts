...
*  are much smarter than we thought.
...
*  where your numbers are high or low or on target.
...
*  if it knows when certain things should be active
...
*  And the first of those three is a physical barrier
...
*  that then allows those white blood cells, neutrophils,
...
*  prior to getting ill, the sickness behavior
...
*  See nauseous, fever, vomiting, diarrhea,
...
*  Dopamine, of course, part of the reward
...
*  and the reason this excites me is not
*  because we want to take science
*  and erase the previous tools and methods
*  of these ancient practices, not at all.
*  And it certainly isn't the case
*  that we just want to name things
*  or rename things with modern science.
...
*  I have in the past, but it's not that I'm a particular
...
*  like breathing, like electro acupuncture and so forth,
...
*  but a really terrific work, Chufu and colleagues.
...
*  and emerging science and hearing about some
*  of the protocols that are either zero cost or low cost,
*  certainly for respiration, that's the case,
*  or for the use of heat or cold,
*  or maybe even electro acupuncture if you have access to that,
*  that we can really see that we're starting to evolve
*  as a field of health and medicine and science
*  and ancient practices and that they're really starting
*  to converge and have a vector, as we say,
...
*  are suggestions for future topics and future guests
*  to have on the Huberman Lab podcast.
*  Please also subscribe to our podcast on Apple and Spotify.
*  And on Apple, you can also leave us up to a five-star review
*  and leave us a comment there as well, if you like.
*  In addition, please check out our sponsors
*  that we mentioned at the beginning of each episode.
...
*  That's T-H-O-R-N-E.
*  Thorne supplements are known to be of the very highest
*  quality and the specificity of the ingredients
...
*  We also, Huberman Lab on Twitter.
