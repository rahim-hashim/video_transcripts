...
*  and sleep in, but who desire to be able to get up
...
*  are already riding pretty high
...
*  you're on travel, whether or not you're eating well
...
*  then supplementation, and then if there's a need,
*  certainly a clinical need, then prescription drugs, et cetera,
...
*  for things like depression involve increasing levels
*  of serotonin in the brain and body.
...
*  are quite potent, in fact, they are power tools
...
*  of things like turkey, canned tuna, and milk.
...
*  as of lately, is Cisis quadrangularis, complicated name.
...
*  A cautionary note, Cisis quadrangularis
...
*  There's not a lot of data on this just yet.
*  There are a lot of opinions about this on the internet,
*  but again, not a lot of quality peer review data.
*  Nonetheless, Cisis quadrangularis has been shown
*  to put increase serotonin in humans,
...
*  and in combination with the magnesium 3-8-apigenin
*  theanine sleep kit that I've talked about
...
*  in this kind of anti-anxiety effect,
...
*  if I've taken 900 milligrams in acetol prior to sleep.
...
*  any time you remove or add something to your drug protocol
...
*  with people that you love, of course.
...
*  things like 5-HTP may have their uses.
...
*  which certainly I experienced if I wake up
...
*  baseline levels of those things through things like diet,
*  regular behaviors, and then you have the opportunity
*  to use supplementation and if it's appropriate
*  for you, prescription drugs and certain behavioral protocols
...
*  motivation, relaxation, you're playing
*  with the same neurochemical ingredients.
...
*  that I've provided today allows you a kit
*  of versatile tools that allows you to figure out
...
*  for manipulating acetylcholine
*  are going to be most useful for you and so on and so forth.
...
*  that allows us to know whether or not our dopamine levels
*  are high and our serotonin levels are low.
...
*  detrimental to you, or whether or not they should be used
*  in combinations that would be more useful to you.
...
*  also at hubermanlab.com under the newsletter tab.
