...
*  Then every three minutes or so, they might've looked up
...
*  but in a few moments, we'll talk about how one can use
...
*  in 30 or 40 years.
*  It's a very powerful result in my opinion,
...
*  what the Balsettos Lab and other labs have shown
...
*  they had a rat run on a running wheel.
...
*  which is further away, typically a horizon or something
...
*  when we focus our visual attention on a very narrow point
...
*  not only do we engage that
*  extra receptive extra personal space system,
...
*  of your brain that are related to goal-setting a reward
...
*  It's really important that if you're going
*  to take supplements,
*  that they be of the absolute highest quality.
*  For that reason, we partnered with Thorne THRNE
...
*  you can go to thornethrne.com slash the letter U slash
