...
*  and their sunglasses is that despite being
...
*  are often in subpar, not always,
...
*  And rather than doing that, it actually somehow serves
...
*  because that makes it sound like they're up to something bad,
*  which they might be,
...
*  methylphenidate, also called Ritalin, modafinil,
...
*  insomnia if you drink it too late in the day,
...
*  and it's a disruption in the sorexin hypocretin system.
...
*  I'm not on any of the compounds
*  that I've described during the course of today's episode.
...
*  hyper if that sort of oxymoronic statement,
...
*  It turned out that the right dose of our Modafinil for me
*  was zero milligrams.
...
*  or a structure that's called the pedunculopontine nucleus,
*  the PPN.
*  And then there's a separate collection of neurons
*  in the basal forebrain called unimaginatively nucleus basalis,
...
*  and you have an understanding and hopefully a picture
*  in your mind of how all this is working.
...
*  throughout the day, have been shown to offset some
*  of the effects of age-related cognitive decline,
...
*  of the dopamine system is central
*  to many of the mood disorders such as depression,
...
*  for that purpose as is PEA and phenolathalamin,
...
*  But new PEPT has been shown when taken,
*  you know, at 10 milligrams twice daily,
*  can be more effective than some of the other racetams.
*  What is new PEPT?
*  New PEPT taps into the cholinergic system,
...
*  comparative studies of new PEPT and paracetam
...
*  some degree of inability to focus due to prior concussion
*  or some vascular event, a stroke or ischemia of any kind,
*  because neurons need blood,
*  when the blood supply is cut off to neurons
*  or when there's a bleed in the brain,
*  subsequent to that, often there are challenges
...
*  of new PEPT and paracetam and things like it.
...
*  that I've discussed, racetams and Adderall and Ritalin
...
*  It's on et al, the journal is Neuroplasticity,
...
*  It is a noninvasive tool.
*  It involves taking a coil.
*  It's a device with a coil that's placed
*  over particular locations in the brain
...
*  regardless of whether or not we have preexisting ADHD or not.
...
*  within the phone, it's thought that the brain
*  is struggling now to leave that rapid turnover of context.
...
*  Unlike any other technology humans have ever dealt with
*  before, even though there are trillions,
*  infinite number of bits of information
*  in the actual physical world, your attentional window,
*  that aperture of constriction and dilating that visual window
*  is the way in which you cope with all that
*  overwhelming information typically.
*  Well, within the phone, your visual aperture is set
*  to a given width.
*  It's about this big.
*  Typically the phone seemed to be getting bigger,
*  but nonetheless it's about that big.
*  And within there, your attentional window is grabbing
...
*  on a regular basis lead to deficits
*  in the types of attention that we need
*  in order to perform well in work and school relationships,
*  et cetera?
*  And the short answer is yes, it does appear so.
*  We are inducing a sort of ADHD.
*  And while the studies on this are ongoing
*  because prominent use of smartphones really took off
*  right around 2010 and we're only in 2021,
...
*  but smartphone use and inattention difficulties
*  in attending in 7,102 adolescents.
...
*  I am a big fan of Cal Newport who wrote the book,
*  A Deep Work.
...
*  meaning it can do it, but it diminishes our capacity
...
*  and if you're an adult to two hours per day or less
...
*  to leave us a comment and up to a five-star review.
...
*  and your attention, and as always,
