...
Length: 8217s
Video Keywords: ['andrew huberman', 'huberman lab podcast', 'huberman podcast', 'dr. andrew huberman', 'neuroscience', 'huberman lab', 'andrew huberman podcast', 'the huberman lab podcast', 'science podcast', 'creativity', 'divergent thinking', 'meditation']
Video Views: 329031
Video Rating: None
---

# The Science of Creativity & How to Enhance Creative Innovation | Huberman Lab Podcast 103
**Andrew Huberman:** [December 19, 2022](https://www.youtube.com/watch?v=KPlJcD-o-4Q)
...
*  Today, we'll talk about what those neural structures are,
...
*  to access creativity that include narrative and storytelling,
...
*  to be able to apply these tools in different domains of life,
*  work, family, play, and on and on.
*  By the end of today's episode,
*  you will have a better understanding of what creativity is
*  and how to access it, and, if you like,
*  to bring others into your creative endeavors,
*  which, as you'll soon learn, can massively expand
*  the extent to which you yourself
...
*  So for those of you that find it a struggle to focus
*  or to refocus in more traditional forms of meditation,
...
*  that have to occur in your eye and brain.
*  Roka understands these kinds of adaptations
*  and the other ones required to see clearly.
*  And those are built into the engineering
*  of their sunglasses and eyeglasses.
*  One of the things that makes Roka eyeglasses
*  and sunglasses so terrific
*  is that they are extremely lightweight.
*  In fact, most of the time,
*  I don't even realize that they're on my face.
*  I wear sunglasses when I drive
*  and whenever I need to throughout the day
*  and I wear readers at night.
*  I do not wear sunglasses when I get my morning sunlight,
*  which I do every single morning
*  as you should be doing also
*  as is covered many times on this podcast.
*  Roka eyeglasses and sunglasses are also unique
*  in that unlike a lot of so-called
*  performance eyeglasses out there,
*  they don't make you look like a cyborg.
*  They have some of the styles
*  that make you look like a cyborg if that's your thing.
*  But if you want to wear glasses or sunglasses
*  out to dinner or around for social reasons,
*  they have many different aesthetic styles to choose from.
...
*  that can enhance brain function
...
*  and that allow you to enter the brain and bodily states
*  that are optimal for things like focus,
*  energy, creativity, and so on.
...
*  that is sodium, magnesium, and potassium
*  in the precise ratios that you need without sugar.
*  As I've talked about many times before in this podcast
*  and elsewhere, every cell in your body
*  requires hydration and electrolytes
*  in order to function properly.
*  And a key example of this are the neurons,
*  the nerve cells of your brain
*  that allow you to think clearly,
*  to exercise hard, et cetera.
*  Neurons require sodium in order to fire
*  what are called action potentials
*  or electrical signaling between neurons.
*  And they require potassium and magnesium.
*  And those have to be present in the correct ratios
*  in order for your brain and body to function optimally.
*  Element is formulated to help anyone
*  with their electrolyte needs
*  and is perfectly suited to anyone following
*  a ketogenic, low carbohydrate, or paleolithic diet,
*  or a basic omnivore diet, which is the one that I follow.
...
*  which I should mention tastes especially good
*  if you actually heat it up.
*  So if you treat it sort of like a tea, it works.
*  Or if you drink it cold, it's delicious.
*  All the flavors of Element I find delicious.
...
*  that are different, and that we don't really think
*  of as creative.
*  In fact, they can be downright trivial.
*  For instance, if I were to take a fish tank
*  and put wings on it, that's a novel combination of things,
*  which is one of the key criteria for an act or an object
*  or a piece of music that is creative.
...
*  And I must say that oftentimes, the most creative
*  and the most interesting and the most beloved creative acts
*  reveal to us something fundamental about the world
*  or the way that we work in a way that delights
*  and thrills and surprises us, but that we aren't even aware
*  what that fundamental rule is.
*  I'll return to this in a few minutes,
*  but the time being, let's just build up
...
*  Sure, they're flying fish, although they just kind of jump
*  far, they don't really fly.
...
*  That could be different combinations of music or colors
*  or shapes or technology, et cetera.
*  But it does so in a way that tells us something fundamental
*  and different.
*  Let me give an example of a few truly creative
*  artistic acts.
*  And I'll do that in the domain of visual arts,
*  but of course, there are many examples that could come
*  from music or from other domains, sport, et cetera.
...
*  of a face.
*  If I were to sit you down or if you were to send me
*  a photograph and then I were to paint or draw a picture
*  of your face in a way that faithfully represented
*  the position and shape of your nose relative to the eyes,
*  maybe a, you know, a curl of the lip, maybe a few, you know,
*  hairs of your eyebrows in a particular way
...
*  So for instance, a bird image that's repeated over
...
*  a fundamental feature about the way
*  that our visual system works,
...
*  And the key element here is that what's revealed
*  by an Escher through these repetition patterns
*  is an inversion of the way
*  that our brain normally encodes visual images,
*  and therefore the rule that repetition is suppressed
*  in our visual system,
...
*  is that they reveal a fundamental rule
...
*  That is, he draws or stencils or graffitis
...
*  Now, what's interesting about Banksy
...
*  What's unique about Banksy, or I should say Banksees,
*  the actual art, is that he combines two-dimensional art
...
*  to urinate on the fire hydrant,
...
*  and then the theme tends to pop out.
...
*  that that wall not be breached for whatever reason.
...
*  is really interesting because it's an actual physical
*  barrier, so showing it as the actual physical barrier
...
*  and perhaps where we each individually
*  stand on that controversy.
...
*  but I'll tell you one thing, when you look at a Rothko,
...
*  And in doing so reveals to you what your brain does
*  in order to understand and extract color.
*  Now, in the context of music, for instance,
*  you will sometimes hear a street musician play a song,
*  maybe a Bob Dylan song or Led Zeppelin song
*  or a Pink Floyd song pretty closely,
*  pretty accurately to the way that song is played.
...
*  but the way that sentences are chopped up
*  and fractured reveals to us new meaning
...
*  there is the release of chemicals,
...
*  In fact, if there's one thing I'd really like to impress
*  on everybody is that when thinking about biology,
...
*  then allows us to say, okay, what are the various steps
*  in coming up with a creative idea,
*  in testing a creative idea,
...
*  for each of the three steps to arrive
*  at something truly creative.
*  The first neural circuit involved in creativity
*  is the so-called executive network.
*  This is kind of a goofy name because the neural circuits
*  that I'm about to describe do a bunch of other things
*  as well, but they certainly control
...
*  involves many different sub regions.
...
*  or what numbers to include in a mathematics endeavor,
...
*  or feelings emerge when your eyes are closed.
...
*  that goes from one thought to another distantly in the past
...
*  So by definition, you can no longer be bringing in
*  novel experiences in that moment.
...
*  Okay, so we've got the executive network,
...
*  within the circuits underlying creativity
...
*  Also a brain region called the ACC,
*  or anterior cingulate cortex, and the amygdala.
...
*  The default mode network, which is basically
*  the catalog or library of previous experiences
*  that we have available to us that would act
*  as sort of the paints on a palette
...
*  Okay, so those three networks work together to create things.
...
*  They can also have a particular utility or use in the world,
*  like a piece of technology that is actually useful,
...
*  with novel combinations of things like wings on a fish tank,
...
*  It doesn't allow us to think about or interact
*  with the world or ourselves in novel ways.
...
*  But I want to be very clear that anytime we talk
*  about mechanisms in brain areas,
...
*  That is the verb actions that those particular brain areas
*  engage in order to arrive at a particular endpoint.
...
*  one simple, what we would call a neuroscience
...
*  and you would just write them out or say them out
*  over the next three minutes,
*  that would be an example of divergent thinking.
*  However, if you just said black pen, red pen,
*  white pen, green pen, et cetera,
*  that's not very divergent thinking.
*  It's only divergent in the context of color space.
*  And when I say space, that's just a kind of nerd speak
...
*  If black pen and orangutan are not linked up
*  in our brain and the observer's brain
*  in any kind of meaningful way,
...
*  to suppress certain options, to cross off certain answers.
*  Because again, any answer is valid,
...
*  So this is a different aspect of our prefrontal cortexes,
...
*  It's a wandering through of ideas
*  that you already had in your library,
*  in your memory banks about pens
...
*  I think in movies especially,
*  we have this idea in mind that of this limitless concept
...
*  I'm sure someone put in the comments examples
...
*  they're novel combinations of things
*  that reveal something fundamental
*  and that often pop out to us.
*  If not every time, certainly most of the time
*  that we see that thing.
...
*  And a convergent thinking task would involve
*  you being given a list of two or three
*  or maybe even five different things.
*  And then for each of those two or three
*  or five different things, as quickly as you can
*  to come up with a single answer
*  that binds all of those in a real world concept
*  that obey the laws of nature or physics
*  in some way.
...
*  And so it seems like kind of a mishmash of things
*  that are really just designed for you
*  to try and accomplish an answer
*  rather than something real,
*  such as a plane that lands on water.
*  Okay, the point here is that divergent thinking
...
*  to remember what the initial object or thing
*  that was mentioned was to keep that in mind
...
*  It's a puzzle and it's a puzzle that relies
*  on very distinct brain circuits from divergent thinking,
*  which brain circuits?
*  Well, that's what we're going to describe next.
*  And again, this is not just going to be a list
*  of different brain circuits with different names,
...
*  and informs us about something that we've never seen,
...
*  of dopamine tends to be involved in neural circuits
*  in the brain that are involved in processes
...
*  Okay, the substantia nigra is a brain area
...
*  But areas of the brain like the caudate and putanum
...
*  and then striatals is where it ends up.
...
*  this area is engaged, very interesting brain area.
*  So that's the first circuit, very important to understand.
*  And I'll tell you right now, that is the brain circuit
*  that is engaged when you undergo divergent thinking.
...
*  it becomes more active and the dopamine is involved
*  in that brain activity.
*  And if you recall, divergent thinking involves
*  taking a concept as boring as a pen
*  and thinking about other concepts that could link up
*  with that pen in some sort of way, logical or illogical,
*  right?
...
*  because of some situation where you need to run downstairs
*  in a fire and get back upstairs quickly
...
*  certainly one I've never talked about before in this podcast,
*  which doesn't mean anything except
*  that we haven't gotten to it yet,
*  is the tuberoinfrontibular pathway.
...
*  if you have testes and trigger the release
*  of things like estrogen and testosterone, et cetera,
...
*  of responses in the brain and body when it is active
*  in one or the other of these circuits.
...
*  Now I realized that for some of you listening
*  to this episode, we are probably at the point
*  along the pathway of concept and definition and mechanism
...
*  you're naturally better at divergent and convergent thinking
...
*  and those possibilities can only come from
*  what's contained within our memory systems of our brain,
...
*  And yet what we need to do in order to engage
*  divergent thinking is suppress
*  what is called autobiographical narratives.
*  And in particular, autobiographical narratives,
*  we need to discard with judgments about
*  how certain combinations of things impacted us in the past.
...
*  You hear about this a lot in kind of the self-help
...
*  One way to do it is what's called open monitoring meditation
*  or even just open monitoring thinking.
*  And just to make what could otherwise be
*  a somewhat complex section here, very simple.
*  What I'll also tell you is that if you want to enhance
*  convergent thinking, you can do that a number of ways,
...
*  with eyes open, and that would be
...
*  and take an inventory of them to just merely watch them
*  show up and pass, or maybe become fixated on them
*  for some period of time, or maybe even just one
...
*  practicing open monitoring meditation
...
*  Although of course,
*  daily practice will accelerate the process further.
...
*  which you can think of, or I'd prefer that you think of
...
*  whatever it happens to be that allows you
*  to redirect your focus to a particular location
*  or idea or sound that is known to improve your ability
*  to engage convergent thinking,
*  to quickly parse through or analyze
...
*  And in fact, in the episode that I did
*  with a wonderful guest, Dr. Wendy Suzuki
...
*  And that study greatly increases people's ability to focus.
*  And in fact, their memory, and that's exactly the point,
*  which is that convergent thinking, as I mentioned before,
...
*  where we can spend a morning or a day or a week brainstorming,
...
*  We sometimes see people and companies doing this
*  at retreats, you bring people into a novel environment.
*  You say, let's just forget all the rules
*  and let's just come up with new ideas about some thing,
...
*  So what I just described to you are research-tested tools
*  for training for divergent thinking
...
*  But what I can tell you is that there've been some beautiful
*  what are called loss of function studies
...
*  And now I'd like to talk about how what mood you are in
...
*  how that dictates whether or not you're going to be better
...
*  using tools that are known to trigger additional release
*  of dopamine, which in some cases is good,
*  and in some cases is bad, I should mention.
*  And in other words, determine how you feel in one moment
...
*  And there's a really wonderful correlate or measure
*  of the amount of dopamine that's active in that pathway
*  that can be addressed noninvasively in the laboratory.
...
*  When dopamine levels are lower or less active
*  in this pathway, people tend to blink less.
...
*  are Cermahini and Homel.
*  They're in the Netherlands.
*  So Cermahini and Homel done a number of different papers
...
*  or it can be measured more invasively
*  through brain imaging, even through blood draws
...
*  What tends to happen is that they have lots and lots
*  of ideas, all of those ideas seem really exciting to them.
...
*  like the idea that they're going to run for president
*  tomorrow, this is unfortunately typical
*  of people who have bipolar, which is not to say
*  that everybody who runs for president is bipolar,
...
*  that are very constrained, in other words,
*  not very divergent.
*  So, diversion thinking is favored
...
*  from a manic episode, what Ciaramahenian Hummel
*  have discovered is that if people are in sort of a low mood,
...
*  However, the good news is they are typically very susceptible
*  to elevations in mood through observing
*  or hearing positive stories, listening to music
*  that they like, any kind of so-called inspirational stimuli.
*  Now, this is good news.
*  What this means is that if you're somebody
*  who's not feeling very motivated
...
*  to take external stimuli, things that you know that you like
*  and start interacting with those stimuli
*  to get your mood elevated
*  and then to engage in divergent thinking.
*  However, what Ciaramahenian and Hummel have also shown
...
*  or taking anything in the way of pharmacology
...
*  some sort of intuitive sense as to whether or not
*  our mood is, I suppose we could bin this
*  into three categories, is kind of yes,
*  happy, excited, positive mood.
*  And of course, there are going to be levels to that.
*  Low, kind of like, or kind of meh, kind of in the middle.
*  So if you're in a low mood or kind of meh mood,
*  by all means engage in something
*  probably for about five to 30 minutes
*  that elevates your mood before trying to engage
...
*  It requires just enough focus to be able
...
*  is that caffeine, because of its effects on epinephrine
...
*  but rather use stimulants if you do want to use stimulants
*  such as caffeine prior to convergent thinking.
*  And in fact, in formulating the architecture
*  of today's episode, which took me many hours
*  across many different days, I confess,
...
*  And when structuring everything according to the decisions
*  I had already made, I purposely ingested caffeine
*  prior to that.
...
*  but it doesn't necessarily allow key concepts to pop out
*  in the way that for instance, Banksy or Arathco
*  or an Escher would pop out, okay?
...
*  So I don't recommend that you pay attention
*  to your blinking because that will take you off course
...
*  Again, could be music, could be exercise
...
*  in the particular pathway that's relevant
...
*  Because as Cherimini and Hummel have shown,
*  whether or not you are in a low mood,
*  medium mood or high mood,
*  really can determine whether or not you'll be able
*  to access divergent thinking or not.
...
*  that is their baseline level of dopamine ought to be
*  in this nigrostriatal circuit and in other circuits.
...
*  maybe pharmacologic tools provided they're safe
*  and they're legal in order to either increase dopamine
...
*  If you take a pill or even if you were to inject
*  some substance, again, I hope this would be legal
*  and safe, et cetera, whatever mode of delivery,
...
*  with divergent thinking, the mesocortical pathway
*  associated with cognitive persistence
*  and convergent thinking.
*  If you were to amplify dopamine levels, for instance,
*  by taking the amino acid precursor to dopamine L-tyrosine,
*  something that I occasionally do to enhance dopamine levels
*  for sake of work or energy, 500 milligrams
*  or a thousand milligrams even of L-tyrosine,
...
*  but also in the mesolimbic pathway and also for that matter
*  in the tubroinfraredibular pathway
...
*  or antagonize as it's called dopamine.
*  This is why people who, for instance, have schizophrenia
*  and take drugs to suppress auditory hallucinations,
*  some of those drugs work because they block
*  the so-called D2 receptor of the dopamine pathway.
...
*  of dopamine within the substantia nigra, nigrostriatal,
*  remember, substantia nigra show deficits in what?
...
*  issues with the dopaminergic pathway should not do this.
*  I know nowadays there's a lot of use of drugs
*  that increase dopamine, such as Ritalin, Adderall,
*  Modafinil, Armodafinil, often prescribed
...
*  And that's why those drugs should only be taken
...
*  as are the prescriptions drugs that I referred to before.
*  Tends to be milder.
...
*  of a one to three milligrams per kilogram
*  of body weight per day also will increase
*  dopamine receptor efficacy and density,
...
*  If you are consuming caffeine, but again,
*  caffeine should be taken prior to convergent thinking
*  type tasks probably more than it should be taken
*  prior to divergent thinking tasks.
*  And of course there are other legal supplements
*  that can elevate dopamine as well.
*  In particular, phenol ethylamine is very effective
*  in doing that, 600 milligrams of that has a brief effect
*  lasting only about 30 to 45 minutes,
...
*  very, very high in L-tyrosine, the precursor to dopamine,
...
*  So it's zero cost and it involves no manipulation
*  of brain neuromodulators or chemistry through pharmacology.
...
*  is this is the first study exploring how a chemical
...
*  The first author is K.R.
*  I think I'm pronouncing it correctly,
*  although probably not K-J-A-E-R at all.
*  And the title of the study is increased dopamine tone
...
*  Yoga nidra for instance, is a practice that's been around
...
*  Now, non-sleep deep rest is a acronym,
*  a term that I coined.
*  It's not a term that I coined in order to try
*  and wipe away or discard with yoga nidra.
*  I'm a person who has great respect for yoga nidra
*  and its traditions.
*  It's a term that I coined in order to encompass
*  a number of practices that don't include
...
*  you call it NSDR, whether or not you call it
*  meditation induced shift in consciousness
...
*  into the laboratory.
*  They had them either undergo this self-directed
*  deep relaxation while they are motionless
*  or mostly motionless,
...
*  dopamine changed its levels before, during,
*  and after this particular behavioral practice
*  in one or the other group.
*  And what they discovered is that people
*  who did this deep relaxation,
...
*  during this practice, this yoga nidra like non-sleep
*  or NSDR like practice actually prepared them
*  to be able to move in a much more dedicated
...
*  that is their internal landscape and their ability
*  to imagine new things increased.
*  And in fact, areas of the brain that are associated
*  with visual imagery, such as the visual
*  or so-called occipital cortex and the parietal cortex
*  has been shown in other studies to ramp up
...
*  When we're moving, we can pay attention to things
...
*  I gave the example, which is a trivial one
*  on purpose of a pen,
...
*  And what it points to is the fact that this very simple,
...
*  of the various components that you would use
...
*  anywhere from 10 minutes to 20 minutes, sometimes 30 minutes.
...
*  You can get a sample of what a 10 minute NSDR script
*  looks like that's through Virtus.an, put that out there.
*  So thank you Virtus.an for putting that out there
*  at zero cost.
*  There are examples of 20 and 30 minute NSDR scripts
*  and Yoganidra scripts.
...
*  Yoganidra NSDR script is that you learn to take your body
*  and brain into these states of limited motion,
...
*  And the research data on this now extend
*  beyond this one individual paper.
*  And I think is really exciting because what it says is,
*  as the title and first line of the paper suggests
*  is that we can increase dopamine using specific types
*  of meditation induced consciousness.
*  And those increases in dopamine can be used
*  to increase our ability to be more creative.
*  Before moving forward,
*  I want to make absolutely clear how it is
*  that you would use NSDR AKA yoga nidra or similar.
*  The name doesn't really matter after all.
*  The practice is what matters in order to enhance dopamine
*  in this nigrostriatal pathway and enhance divergent thinking.
*  The key thing to understand here is that the period
*  of motionlessness and deep relaxation while awake
...
*  if you will, of possible solutions or elements to engage
...
*  of dopamine transmission in that circuitry
*  that then positions you to engage
*  in divergent thinking more effectively.
...
*  of such a meditation and NSDR practice.
...
*  for divergent thinking that you do
*  in the hour or hours that follows.
...
*  another neuromodulator, in divergent and convergent thinking.
*  And it turns out that serotonin underlies
*  a lot of the brain activity that's responsible
...
*  psilocybin is still illegal, it is not legal.
...
*  that involves serotonin with microdosing psilocybin.
...
*  but can also shift libido and other things.
...
*  And as I mentioned before, agents,
*  whether or not they are recreational or illicit drugs
*  or prescription drugs or supplements
*  that increase dopamine will also be broadband
...
*  I would say stay tuned for the data on psilocybin
...
*  were contained there
*  on two creativity-related problem-solving tasks.
*  The picture concept task,
...
*  In any case, what they found was an enhancement
*  of creative, that is, divergent and convergent thinking,
*  not surprising given the fact
*  that the 5-HT2A receptor activity is increased
*  by microdosing of psilocybin,
*  and 5-HT2A receptors are present,
*  both on the neural circuits that underlie
...
*  So more on that later, and again, we'll provide a link
...
*  The bottom line on alcohol is that
...
*  And despite what people think, there is absolutely zero,
*  zero evidence that alcohol increases creativity.
...
*  it's our self-awareness,
*  that it can enhance divergent thinking at very low doses.
...
*  Will it won't?
*  All of that autobiographical scripting involves
*  the forebrain being very, very active
...
*  I went in depth into the biology and the various uses,
*  misuses, dangers, and in some cases,
*  benefits of cannabis use in certain,
*  the keyword there is certain populations.
...
*  and motivation, we also seem to have a lot of questions
...
*  simply can't focus.
*  They can, but it tends to be a focus that's selective
*  for things that they are very excited about
*  or interested in, as opposed to a general ability to focus.
*  What's also highly underappreciated is that people
*  who have ADHD oftentimes are very effective
*  at divergent thinking, but are less effective
*  at convergent thinking.
...
*  the convergent thinking that allows creative ideas
*  to be implemented into specific strategies,
*  pressure tested, and eventually delivered
*  in the form of a final product of music, art, et cetera.
*  That is not to say that people with ADHD
*  cannot accomplish that, but that it is going to require
*  some additional steps and protocols
*  in order to enhance convergent thinking.
...
*  and that involves dopamine is also responsible for eye blinks
...
*  there have been some studies of whether or not people
*  are able to engage in divergent thinking more effectively
*  when they are doing things like pacing or walking.
...
*  some of the better ones arrived to me
...
*  or geyser to the surface, I'll have an idea.
*  Sometimes those are good ideas, sometimes less good ideas.
*  The fact that that happens for me
*  and that fact that many people are pacers or runners
...
*  through movement, which then opens up this library of ideas
*  and allows the intersection of different ideas
*  that normally would be constrained to separate categories.
*  One way to think about this by analogy would be,
*  that when I was a kid, you'd go to the library
...
*  to talk into the voice recorder of your phone
*  while walking or simply walking and not attending
...
*  of this what the biologists call a pseudo random walk.
...
*  once you were an adult and allow
*  for smooth directed movement are very precise,
...
*  to cast over that entire thing.
*  The human brain maintains such webs of possible passage
*  and it's only during activities such as walking,
*  running, cycling, swimming, hiking, pacing, et cetera,
...
*  and enhance divergent thinking,
*  those I just want to re-emphasize
*  are designed to position you, to ready you,
*  to engage in the kinds of activities
...
*  Now, this is also an opportunity to underscore
*  something I said back at the beginning,
...
*  to be more creative in a domain
...
*  to some important practices that we can all use
...
*  is beautifully encapsulated in an article entitled,
...
*  What this theory is from Guilford essentially states
...
*  We know there's standard IQ, et cetera.
...
*  we are the house cats and the cats are actually the ones
*  that are the curators of the earth.
*  Okay, so right there, there's a conceptual shift
...
*  Other things are not possible that are very different
...
*  But rather than just say, take the perspective
*  of somebody else in terms of what they would see or do
*  or say or think, rather, we are supposed to think
...
*  for being angry is.
*  Maybe they had a breakup, maybe they were jealous,
...
*  what are called creative collisions.
...
*  like we arguments fighting physical or verbal or otherwise.
*  They could be synergistic.
*  They could take on any number of different forms,
*  depending on the motivations and the individuals
*  that are involved.
...
*  that has been created, which we consider great
*  and novel works, and you start to find these three elements,
*  world building, perspective shifting,
*  and action generating techniques.
*  And so, while this is, again, just a broad contour
...
*  this is distinct from divergent thinking,
...
*  to assume identity, build identity,
*  and understand rules about the actual world we live in,
*  all of those basic elements of early childhood creativity
*  can be reawakened, and in fact, they have data
*  to support the fact that they can be reawakened
*  in adults in meaningful ways that can lead
*  to new product design, new workplace interactions,
*  and on and on.
...
*  of brain function.
*  And in particular, because we don't actually know
...
*  that can allow us to better access divergent thinking
*  and convergent thinking.
...
*  or suggestions about guests that you'd like us to interview
*  on the Huberman Lab podcast,
...
*  at the beginning and at various times during today's episode.
*  That's the best way to support this podcast.
*  As mentioned at the beginning of today's podcast,
...
*  which turns out to be most effective
*  in building a supplement protocol.
*  And when I say most effective,
*  I mean most biologically effective and most cost effective.
*  And we're fortunate that they ship internationally
*  because we know that many of you reside
*  outside of the United States.
*  If you want to check out the supplements mentioned
*  in today's and in other episodes of the Huberman Lab podcast,
*  supplements that are aimed at enhancing sleep,
*  enhancing focus, hormone support, et cetera,
*  you can go to Live Momentous, spelled O-U-S.
...
*  this is a monthly newsletter that is completely zero cost
*  that has summaries of particular podcast episodes,
*  as well as toolkits for things like enhancing sleep,
*  enhancing focus, dopamine, deliberate cold exposure,
*  and many other topics important to the listeners
*  of the Huberman Lab podcast.
*  If you'd like to join the newsletter,
*  please go to hubermanlab.com, click on the menu
...
*  for today's discussion,
*  all about the science and tools for creativity.
