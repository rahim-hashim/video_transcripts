...
*  foods I should eat, timing of eat, and so on and so forth.
...
*  Are those sorts of vocalizations produced
...
*  in pesticides and foods that are changing hormone levels.
...
*  And DNA, but with those four base pairs
...
*  That slanted overstate in his wheelchair.
*  Exactly.
...
*  and engineers there.
*  We hear a lot about Neuralink because
*  while brain machine interface of the sort that you do
*  and that other laboratories do
...
*  or one person with many people through a podcast,
*  for instance, or a speech.
...
*  50 conversations in parallel, 50X communication,
...
*  things of that sort before they embark
*  on the more sci-fi like explorations
*  of 50Xing communication or doubling memory capacity
*  and these kinds of things.
*  Although I don't know,
*  I'm not understanding all of those things in parallel.
...
*  But we have our Einstein's and our Feynman's
*  and our Merzenich's and it's unclear
...
*  to achieve supra human or superhuman
...
*  And here we don't even have to think about
*  neural link in particular.
*  It's just but one example of companies and people
*  in laboratories that are quite understandably
...
*  And a lot of the early work was just trying to restore
*  things like our movement or having people or monkeys
*  control a computer cursor, for example, on the screen.
*  That's been going on for decades.
*  What's been really new is that industry
*  is now involved and some of this
*  is now becoming commercialized.
...
*  Can you build a device that essentially
*  enhances someone's ability beyond super normal,
*  super memory, super communication speeds
...
*  I personally don't think that we've thought enough
*  actually about what these kind of scenarios
*  are gonna look like.
...
*  to speak and to communicate have evolved over
...
*  This is not new territory, this topic of augmentation,
*  both physical and cognitive.
*  We've already surpassed that.
*  That's part of what humans do in general.
*  But we are entering this area of enhanced cognition,
*  these areas that I think the technology
*  is gonna be the rate-limiting step in how far we can go.
*  And we have not had the full conversations about,
...
*  with patients like Pancho to move beyond somebody
*  who's locked in, being able to type out words
*  on a screen with their thoughts.
*  There's a rich array of information
*  contained within the face and facial expression.
*  And while somebody like Pancho going from having to
*  be completely locked in to being able to peck out letters
*  on a keyboard to being able to just think of those letters
...
*  who are quadriplegic, a lot of what they struggle with
*  in the reward is actually a height difference sometimes
...
*  I think it's the right time to start really thinking
*  about a broader vision of what communication really is.
...
*  For example, if you have a quizzical look on your face,
*  if I'm saying something not clear,
*  that's a sign to me that I need to rephrase it
*  or to say it in a different way or to slow down, for example.
*  Or if there's something that really excites you,
*  I wanna continue to say more about it
*  and talk more in detail, essentially about a given thing.
*  So facial expressions actually are a really important part
*  of the way we speak.
*  And there's two things.
*  It's not just the expressions of how you're feeling
...
*  is gonna improve the intelligence brilliantly,
...
*  I suppose, if we were to sort of translate this to-
*  Exactly.
*  The real world.
*  Exactly, and the reason why we're also very interested
...
*  is gonna be a more complete form of expression.
...
*  more than even now,
*  are gonna move into this digital virtual space.
...
*  And how are they gonna participate in that?
*  And so we were thinking really about,
...
*  things that can essentially decode
*  essentially their expressions or the movements
*  associated with their mouth and jaw
...
*  It'll be an image of my avatar saying
*  whatever it is I happen to be tweeting at that moment.
*  That's what we're working on.
*  Yeah, so I don't think that that is gonna happen
*  and it's gonna happen soon.
*  And there's a lot of progress in that.
*  And again, we're just trying to enrich
*  the field of communication, expression,
...
*  That is gonna be the way that can help people learn
*  how to do it the quickest,
...
*  about people using filters to make their skin
*  look different or the lighting look different,
...
*  through spoken language from an avatar that looks like them
...
*  Yeah, great question.
*  Stutter is a condition where the words
*  can't come out fluently.
*  So you have all the ideas, you've got the language intact.
*  Remember we talked about this distinction
...
*  And stuttering is a condition where
*  people have a predisposition to it.
...
*  we're not even conscious of what is going on in our mouths,
*  in our larynx.
*  We're not conscious, and if we were,
*  we would not be able to speak because it's too complex.
*  It's too precise.
...
*  So stuttering is essentially a breakdown at certain times
...
*  but it won't emit.
*  And so a lot of that therapy is really just focusing on
*  how do you create the conditions for that to happen?
...
*  And it's giving us a clue that the brain is not
*  just focused on sending the commands out,
...
*  in those particular moments where this very, very precise
*  coordination needs to happen in the brain
...
*  and frankly, to me, it seems like you're running
*  a lot of operations and no pun intended,
*  in parallel when you're doing surgery,
...
*  I can tell, for example, if I don't go on a run or a swim
*  just after a day or two, and it can have translation,
*  for example, and the way I feel in the operating room
...
*  that are like routine and rote and are from muscle memory.
...
*  because that intense focus allows me to disconnect
...
*  My emotions are going through routines.
...
*  Well, music helps me just stay motivated and distracted
*  from being out of breath and other things.
*  And for me, it's a way just to catch up with the world.
*  So sometimes I do, but I do notice that I don't run as well,
*  for example.
*  In the operating room, it's a little different.
*  Different surgeons have preferences.
*  I'm more of the camp where I don't like
*  any distraction whatsoever.
...
*  I think just being there alone and just trying
*  to treat it the way it is, it's a sacred moment
*  where someone's life is really directly under your hands.
...
*  because they're really going to the farthest reaches possible
*  and they're testing and probing and really at the front edge
*  of discovering from the species that we arguably care
*  about the most, which is humans.
*  Eddie, I have to say from the first time
*  we became friends 38 years ago.
*  Something like that.
*  Something like that.
...
*  I mean, the story of Pancho is about one
...
*  I'm very humbled basically by what you just said.
*  And I feel that it's really an extraordinary honor
*  actually and privileged to be here with you
...
*  How do we apply the knowledge that we learned one day
...
*  or this other trail,
*  which one is gonna be the one that is gonna be safe
...
*  being one of the people doing it.
...
*  his clinical website,
*  and other resources related
*  to his critical research as well.
