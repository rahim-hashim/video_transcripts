...
*  that are good for you mixed into this
...
*  of their air stream, so to speak.
...
*  their attention to drift, although they do that
*  when they want to be in highly efficient mode,
...
*  to the functioning of their body, but that when needed,
*  that they can focus their energy in
...
*  But if you try this next time you're out for a run or a swim,
...
*  It's essentially the 5,000 meter race,
...
*  basically was pulling from strength, speed, power,
*  muscular endurance, long duration effort,
*  high intensity aerobic and anaerobic,
*  because he sort of tried to maximize every fuel system.
...
*  which allows us to access whatever resources happen
...
*  or protocols that one could adopt in a link on the show notes
...
*  One are stimulants.
*  So things like caffeine will definitely improve
*  endurance work and power output.
...
*  in which case you're extremely sore.
...
*  being below your VO2 max and your ability to be efficient
*  for long bouts of more than 12 minutes of exercise.
...
*  allow us to bring this zero-cost to consumer information
...
*  to get zero cost updates about speaking events,
*  about any book releases or exciting things
*  that I'm reading that I think you would enjoy reading
*  as well, as well as protocols related to science
