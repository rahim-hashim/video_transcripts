...
*  They did that, but they correlated that
...
*  can be monitored somewhat better than EEG.
...
*  one's perception of self as seen
*  through the relationship to the other.
*  And this is something that was developed by,
*  that the authors are Aaron and Aaron,
...
*  A-R-O-N and A-R-O-N, Aaron and Aaron in 1986
*  proposed the self-expansion model of close relationships.
...
*  In any event, this study looked at whether or not people
*  have high levels of self-expansion through the actions
*  or statements of their significant other
...
*  whether or not their self-expansion is very strongly driven
*  by the other person that they are involved with,
...
*  to experience self-expansion through others.
...
*  They heard their significant other say
...
*  with assessing others attractiveness,
*  then did the people who experienced
*  a lot of self-expansion.
*  Now, the takeaway from that,
*  at least the way I read this study is,
*  if you're with somebody who really benefits from
...
*  people who have or that rate high
...
*  It's not that their opportunities
...
*  the title manipulation of self-expansion alters responses
...
*  I can filter that through these findings to say
*  that it's really the person who needs a lot
*  of self-expansion stimulating statements
...
*  person B, that will form a very stable bond.
...
*  that while it is important to link
*  our autonomic nervous systems to establish desire,
*  love and attachment,
...
*  which is that our biology that resides
*  below our conscious awareness,
*  things like our hormones,
*  things like pheromones even,
*  are shaping the way that we choose,
*  interpret and act with other potential romantic partners
*  or the romantic partners that we already have.
*  Now, this cannot be overemphasized, right?
*  No matter how much we would like to
*  create a sort of top-down description,
...
*  And I would say that one of the more exciting,
*  fascinating and indeed mysterious aspects of desire,
*  love and attachment are those subconscious processes,
...
*  please check out that episode as well
*  as what I'm going to talk about in just a moment here.
...
*  As I described in that testosterone
...
*  to libido and sex drive and the pursuit and ability to mate.
...
*  Now, with that said, there are things
*  that can shift libido in both men and women
...
*  into a chronic pursuit, but an inability to perform sexually.
...
*  mind and body are enhanced, but not so much so
...
*  are under the impression that if they just drive up
*  testosterone, increase dopamine and generally get themselves
*  into high states of autonomic arousal,
*  that that's going to increase the libido.
...
*  research to support them are MACA,
*  M-A-C-A, which is actually a root,
...
*  of MACA root.
*  It goes by the name L-M-I-E-N-E.
*  These always have fancy names
*  and the Latin names in biology are always more complete,
*  but it's MACA root for the management of SSRI
*  induced sexual dysfunction.
*  First author is Doherding D-O-R-D-I-N-G.
...
*  In this case, just 1.5 grams per day
*  up to a high dose, three grams per day of MACA.
*  And they were doing this in 20 remitted depressed outpatients.
...
*  sexual effects and MACA seemed to offset some of those effects
...
*  from 1.5 to 3 milligrams, meaning one, excuse me,
*  1500 milligrams to 3000 milligrams or placebo.
...
*  and is a substance that some people supplement is known,
*  for instance, to increase sexual desire,
...
*  Tongat Ali goes by a number of different names.
*  One of them is exceedingly difficult for me to pronounce.
*  It's Uricoma longifolia, also called long jack,
*  but Tongat Ali is the typical name.
*  This is an herb.
*  There's a Malaysian version and an Indonesian version.
*  My understanding is that the Indonesian variety
*  of Tongat Ali is the one that is most potent
*  for its effects on libido.
*  Previously, I've talked about Tongat Ali
...
*  And there's some evidence that Tongat Ali
...
*  of Tongat Ali increasing libido.
*  One particular article, last author,
*  or I should say last name of first author, excuse me,
*  Ismail, I-S-M-A-L.
*  This was published in an evidence-based complementary
*  and alternative medicine.
*  It's from 2012,
*  reports a significant increase in libido and sexual function.
...
*  that I know do take Tongat Ali,
...
*  The only way to determine that is really to do your bloodwork,
...
*  Typically, Tongat Ali and MACA are not cycled
...
*  to monitor your bloodwork,
*  as well as subjective measures in evaluating
...
*  for increasing testosterone for fitness purposes and so on.
...
*  ranging anywhere from 18 years old all the way up to 65 plus,
*  they say 65 plus, I guess that could be 70,
*  could be 80, I don't know,
...
*  increased in the group taking Tribulus terrestis.
...
*  and it did seem to increase
*  various aspects of sexual function.
...
*  that explored the role of Tribulus,
...
*  Maka, Tonga Ali, in particular, Indonesian Tonga Ali,
*  and Tribulus can indeed create significant increases
*  in sexual desire, and in some cases,
*  by adjusting the testosterone and estrogen system,
*  in some cases, not by adjusting the testosterone
*  and estrogen system, again, pointing to the complexity
*  of neurochemicals and features that adjust things
*  like libido, aka desire.
...
*  of the vast landscape that is the psychology
...
*  on Apple and Spotify, and on Apple,
*  you have the opportunity to leave us
*  up to a five-star review.
*  In addition, please leave us comments, feedback,
...
*  I teach neuroscience and neuroscience-related tools
