...
*  super high intensity training once per week
...
*  or as you'll soon hear, whereas on Friday,
...
*  And the way I do that is by getting
*  into a hot sauna.
...
*  I want to be strong in not just my legs,
*  but my upper body.
...
*  repeat, and I'll do that for anywhere from eight
...
*  but at least about 30% of those sets, I'm going to failure.
...
*  And I should say that the same basically
*  applies to endurance work.
...
*  But the basic takeaway from that episode is that
*  if you look at what I like to call the center of mass
*  of the research, that is most of the studies
*  and what the conclusions of most
*  of the quality studies point to.
...
*  and relaxing the midsection and torso
*  and relaxing into the stretch as opposed
*  to staying full of air and tense,
...
*  So it could be for quadriceps, could be for hamstrings,
*  for your lats, there are protocols out there.
...
*  And I really try and space that out throughout the week,
...
*  ideally every day.
*  But truth told, I fail.
*  I categorically fail.
*  I was about to think of whether or not
*  I ever stretch every day.
*  I fail to do it every day,
*  but I get about three or so stretching sessions in per week.
...
*  in moving that dumbbell with the arm
...
*  or an isometric position.
*  So the nervous system of course is what controls muscles
*  and that operates in both directions.
*  If you want to relax, try and use long exhales,
*  maybe even physiological size and really concentrate
...
*  because I suppose as a neuroscientist,
...
*  toward a long lifespan and health span.
...
*  to hang from a bar,
*  depending on their age and their fitness level, et cetera.
...
*  as long as possible,
*  which turns out to be a interesting
...
*  That is, if you were really congested and you had a headache,
*  you could still run.
...
*  or percentage of sets to failure
*  from about 30% of sets to maybe closer to 10% of sets,
*  something like that.
...
*  avoid getting myself stressed out and focus on sleep,
*  NSDR, other forms of recovery, good nutrition, et cetera.
...
*  and that I do believe should come
...
*  and the description of this protocol and all its variables
*  is really for you and for you to tailor
...
*  for our discussion about building
*  your optimal toolkit for fitness.
