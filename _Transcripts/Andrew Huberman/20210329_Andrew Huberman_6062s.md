...
*  the emotions of others are important to you
*  in a given context.
...
*  Okay, so babies are starting to evaluate and do all this,
...
*  Gonadotropin-releasing hormone then causes the release
...
*  that all we're trying to do is figure out
