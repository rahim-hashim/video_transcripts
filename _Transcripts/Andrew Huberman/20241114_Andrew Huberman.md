...
Length: 2096s
Video Keywords: ['andrew huberman', 'huberman lab podcast', 'huberman podcast', 'dr. andrew huberman', 'neuroscience', 'huberman lab', 'andrew huberman podcast', 'the huberman lab podcast', 'science podcast', 'huberman lab essentials', 'nervous system', 'brain', 'brain function']
Video Views: 187137
Video Rating: None
Video Description: This is the first episode of Huberman Lab Essentials — short episodes (approximately 30 minutes) focused on essential science and protocol takeaways from past Huberman Lab episodes.
...
**Andrew Huberman:** [November 14, 2024](https://www.youtube.com/watch?v=HiyzzcuaAac)
...
*  but these are the bits and pieces that together
...
*  is because it makes certain neurons and neural circuits,
*  as we call them, more active and others less active.
*  Okay, so serotonin, for instance,
...
*  where somebody is so relentlessly
*  in pursuit of external things like money and relationships
...
*  on a poorly filtered web browser, or they can be deliberate.
...
*  groups of neurons that generate right foot,
*  left foot, right foot, left foot kind of movement.
*  However, when you decide to move in a particular
*  deliberate way that requires a little more attention,
...
*  or should be done, path, what you should be doing,
...
*  And it feels like agitation because it's accompanied
*  by the release of a neuromodulator called norepinephrine,
...
*  It's going to feel challenging because the chemicals
*  in your body that are released in association
*  with that effort are designed
*  to make you feel kind of agitated.
...
*  and allow brief periods of time in which
*  whatever information, whatever thing we're sensing
*  or perceiving or thinking, or whatever emotions we feel
...
*  to get neuroplasticity as an adult through traumatic
*  or terrible or challenging experiences.
...
*  wait, which neurons were active in this particularly
*  alerting phase of whatever day or night,
...
*  in the future, even without us thinking about it.
...
*  one can continually bring to whatever it is
...
*  to get triggered, but the actual rewiring occurs
...
*  It was not done by my laboratory that showed
*  that 20 minutes of deep rest, this is not deep sleep,
*  but essentially doing something very hard
*  and very intense and then taking 20 minutes afterward,
*  immediately afterwards, to deliberately turn off
...
*  was especially important, so much so that that bell
...
*  at that particular time of day, and the learning rates
*  and the rates of retention,
...
*  and outcome analysis are impossible.
...
*  to go from being deliberate and hard
*  and stressful and a strain to easy and reflexive.
...
*  in these very focused duration path outcome types
*  of analysis to states in sleep that are completely divorced
...
*  in duration path outcome types of analysis.
...
*  And so you really need to learn how to
*  wedge into those 90 minute cycles.
...
*  to engage in a focused bout of learning each day.
*  And now we know how long
*  that focused bout of learning should be.
...
*  can learn to drop into a mode of more focus,
*  get more neural plasticity, in other words,
